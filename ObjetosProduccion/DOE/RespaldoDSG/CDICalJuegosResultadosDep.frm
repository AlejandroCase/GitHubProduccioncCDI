...
[Forma]
Clave=CDICalJuegosResultadosDep
Icono=0
Modulos=(Todos)
...
FiltroTodo=S
FiltroGrupo2=CDICalJuegosResultados.NoVuelta
FiltroGrupo3=CDICalJuegosResultados.NoJornada
...
[Acciones.CDICalJuegosResultadosDep]
Nombre=CDICalJuegosResultadosDep
Boton=4
NombreEnBoton=S
NombreDesplegar=Calendario Juegos / Resultados
EnBarraHerramientas=S
TipoAccion=Reportes Pantalla
ClaveAccion=CDICalJuegosResultadosDep
ListaParametros=S
Activo=S
Visible=S
...
CDICalJuegosResultados.NoJornada=CDICalJuegosResultados.Dia
...
Presentacion preliminar=CDICalJuegosResultadosDep
CDICalJuegosResultadosDep=(Fin)
