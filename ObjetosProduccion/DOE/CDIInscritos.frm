...
FiltroGeneral={si(condatos(Info.CteActividad),<T>CDICteCat.Actividad=<T>+comillas(Info.CteActividad),<T>1=1<T>)}
...
[Acciones.CDIInscritosSI]
Nombre=CDIInscritosSI
Boton=0
NombreDesplegar=CDIInscritos(Solo Inscripciones test)
EnMenu=S
TipoAccion=Formas
ClaveAccion=CDIInscritosSI
Activo=S
Visible=S
Menu=Reportes
...
[Acciones.CteActividad.Actualiza]
Nombre=Actualiza
Boton=0
TipoAccion=Controles Captura
...
[Acciones.CteActividad.ListaAccionesMultiples]
(Inicio)=CteActi
CteActi=Actualiza
Actualiza=(Fin)
...
CDICEAsistenciaV2014=CDIInscritosSI
CDIInscritosSI=CteActividad
CteActividad=(Fin)
