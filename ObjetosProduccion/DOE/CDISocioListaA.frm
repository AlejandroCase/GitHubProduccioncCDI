...
MenuLocal=S
FiltroGeneral=Cte.Tipo<><T>Estructura<T><BR>{Si(no Usuario.ConsultarClientesOtrosAgentes, <T> AND Cte.Agente=<T>+Comillas(Usuario.DefAgente), <T><T>)}<BR>AND Cte.CDISocio = 1
ListaAcciones=(Lista)
[Lista.Columnas]
Cliente=127
Nombre=293
