...
ListaParametros1=ArtMaterial:ArtMaterial.Material<BR>ArtMaterial:ArtMaterial.Almacen<BR>ArtMaterial:ArtMaterial.SubCuenta<BR>ArtMaterial:ArtMaterial.Cantidad<BR>Nulo<BR>Nulo<BR>Nulo<BR>Nulo<BR>Nulo<BR>ArtMaterial:Art.Descripcion1<BR>ArtMaterial:Art.Tipo<BR>ArtMaterial:ArtMaterial.Unidad<BR>Nulo<BR>ArtMaterial:Art.TipoOpcion<BR>Nulo<BR>Nulo<BR>Nulo<BR>Nulo
ListaParametros=S
Activo=S
Visible=S
...
TipoAccion=Wizards
ClaveAccion=Asistente Articulos
ListaParametros1=ArtMaterial:ArtMaterial.Material<BR>ArtMaterial:ArtMaterial.Almacen<BR>ArtMaterial:ArtMaterial.SiOpcion<BR>ArtMaterial:ArtMaterial.Cantidad<BR>Nulo<BR>Nulo<BR>Nulo<BR>Nulo<BR>Nulo<BR>ArtMaterial:Art.Descripcion1<BR>ArtMaterial:Art.Tipo<BR>ArtMaterial:ArtMaterial.Unidad<BR>Nulo<BR>ArtMaterial:Art.TipoOpcion
ListaParametros=S
...
AntesExpresiones=Asigna(Info.Articulo, ArtMaterial:ArtMaterial.Articulo)
