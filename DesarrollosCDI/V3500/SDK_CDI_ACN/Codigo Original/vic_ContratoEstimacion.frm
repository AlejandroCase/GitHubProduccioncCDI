...
ListaEnCaptura=vic_ContratoEstimacion.Comentarios
...
Expresion=Asigna(Info.Forma, <T>vic_ContratoPosicion<T>)<BR>Asigna(Info.Nombre, <T>Posicion<T>)<BR>Asigna(Info.Modulo, Nulo)<BR>Asigna(Info.Mov, Nulo)<BR>Si                                       <BR>  Forma(<T>PlantillasOffice<T>)<BR>Entonces<BR>   PlantillaOffice( Info.PlantillaID ) <BR>Fin
[Acciones.Evento]
Nombre=Evento
Boton=0
Menu=&Edición
...
EjecucionCondicion=ConDatos(vic_ContratoPosicion:vic_ContratoPosicion.ID) y ConDatos(vic_ContratoPosicion:vic_ContratoPosicion.IDContrato)
AntesExpresiones=Asigna(Info.Cliente, vic_ContratoPosicion:vic_ContratoPosicion.ID)<BR>Asigna(Info.Nombre, vic_ContratoPosicion:vic_ContratoPosicion.Nombre)
...
BtnResaltado=S
EjecucionCondicion=ConDatos(vic_ContratoPosicion:vic_ContratoPosicion.ID) y ConDatos(vic_ContratoPosicion:vic_ContratoPosicion.IDContrato)
AntesExpresiones=Asigna(Info.Modulo, <T>VICPO<T>)<BR>Asigna(Info.Cuenta, vic_ContratoPosicion:vic_ContratoPosicion.ID)<BR>Asigna(Info.Descripcion,  vic_ContratoPosicion:vic_ContratoPosicion.Nombre)
[Acciones.Navegador]
Nombre=Navegador
Boton=0
...
Vista=CtaBitacora
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=vic_ContratoEsimacion
LlaveLocal=CtaBitacora.Cuenta
LlaveMaestra=vic_ContratoEstimacion.ID
...
FiltroGeneral=CtaBitacora.Modulo=<T>VICES<T>
...
(Inicio)=vic_Condicion.Fecharev
vic_Condicion.Fecharev=vic_Condicion.MesesRev
vic_Condicion.MesesRev=vic_Condicion.IncIndice
vic_Condicion.IncIndice=vic_Condicion.IncFactor
vic_Condicion.IncFactor=vic_Condicion.IncMas
vic_Condicion.IncMas=vic_Condicion.ImportePactado
vic_Condicion.ImportePactado=(Fin)
...
vic_Condicion.AgregaMesAno=vic_Condicion.Importe
...
vic_Condicion.Agrupador=vic_Condicion.ConsideraM2
vic_Condicion.ConsideraM2=vic_Condicion.SerieFactura
...
ListaEnCaptura=(Lista)
[Comentarios.vic_ContratoEstimacion.Comentarios]
Carpeta=Comentarios
Clave=vic_ContratoEstimacion.Comentarios
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Estimaciones.vic_ContratoEstimacion.TipoEstimacion]
