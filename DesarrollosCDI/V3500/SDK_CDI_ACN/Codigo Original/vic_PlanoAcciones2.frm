...
GuardarAntes=S
Antes=S
ActivoCondicion=(ConDatos(vic_PlanoAcciones:vic_PlanoAcciones.Plano)) y<BR>(ConDatos(vic_PlanoAcciones:vic_PlanoAcciones.Nombre))
...
[Detalle.vic_PlanoAcciones.AplicaProm]
Carpeta=Detalle
Clave=vic_PlanoAcciones.AplicaProm
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.vic_PlanoAcciones.QueryColor]
Carpeta=Detalle
Clave=vic_PlanoAcciones.QueryColor
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
vic_PlanoAcciones.Query=vic_PlanoAcciones.QueryColor
vic_PlanoAcciones.QueryColor=vic_PlanoAcciones.AplicaProm
vic_PlanoAcciones.AplicaProm=(Fin)
...
Guardar=Nuevo
Nuevo=Eliminar
Eliminar=AccionesDef
AccionesDef=Navegador
Navegador=(Fin)
