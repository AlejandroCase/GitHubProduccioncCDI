...
[Acciones.RepProyCxcEstadoCuenta]
Nombre=RepProyCxcEstadoCuenta
Boton=0
NombreDesplegar=Estado de Cuenta
EnMenu=S
TipoAccion=Formas
ClaveAccion=RepProyCxcEstadoCuenta
Antes=S
...
ActivoCondicion=ConDatos(Proy:Proy.Cliente)
AntesExpresiones=Asigna(Info.Cliente, Proy:Proy.Cliente)
...
Evaluaciones=Anexos
Anexos=Doc
Doc=RepProyCxcEstadoCuenta
RepProyCxcEstadoCuenta=(Fin)
