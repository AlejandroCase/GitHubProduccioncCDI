...
BarraHerramientas=S
VentanaEscCerrar=S
ExpresionesAlMostrar=Asigna(Info.Articulo, Nulo)<BR>Asigna(Info.Cliente, Nulo)<BR>Asigna(Info.Moneda, Usuario.DefMoneda)<BR>Asigna(Info.FechaD, PrimerDiaMes)<BR>Asigna(Info.FechaA, UltimoDiaMes)<BR>Asigna(Info.Nivel, <T>Dia<T>)<BR>Asigna(Info.Vista, <T>Normal<T>)
...
Activo=S
Visible=S
Expresion=IrAuxiliar(<T>VTAS<T>, Info.Articulo, Info.Moneda, Info.FechaD, Info.FechaA, Info.Nivel, Info.Vista, Info.Cliente)
