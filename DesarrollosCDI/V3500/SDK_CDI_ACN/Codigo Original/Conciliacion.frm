...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Conciliacion:Conciliacion.Usuario) y <BR>(Conciliacion:Conciliacion.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>CONC<T>, Conciliacion:Conciliacion.Mov, Conciliacion:Conciliacion.Estatus, FormaSituacion) y<BR>(Conciliacion:Conciliacion.Estatus=EstatusSinAfectar)
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>CONC<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>CONC<T>, Conciliacion:Conciliacion.Mov, Conciliacion:Conciliacion.Estatus, FormaSituacion)
