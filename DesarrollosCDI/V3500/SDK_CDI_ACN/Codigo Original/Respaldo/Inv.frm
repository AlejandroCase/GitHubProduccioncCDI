...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Inv:Inv.Usuario) y <BR>(Inv:Inv.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar, EstatusPendiente))  y<BR>PuedeAvanzarEstatus(<T>INV<T>, Inv:Inv.Mov, Inv:Inv.Estatus, FormaSituacion)
...
ActivoCondicion=Si<BR>  PuedeAfectar(Usuario.Cancelar, Usuario.CancelarOtrosMovs, Inv:Inv.Usuario) y ConDatos(Inv:Inv.ID) y ConDatos(Inv:Inv.MovID)<BR>Entonces<BR>  Si<BR>    MovTipoEn(<T>INV<T>, Inv:Inv.Mov, (INV.P, INV.IF, INV.SOL, INV.OT, INV.OI, INV.TI, INV.SM))<BR>  Entonces<BR>    Inv:Inv.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusSincro, EstatusPorConfirmar, EstatusPendiente)<BR>  Sino<BR>    Inv:Inv.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusSincro, EstatusPorConfirmar, EstatusConcluido, EstatusPendiente)<BR>  Fin<BR>Sino<BR>  Falso<BR>Fin
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>INV<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>INV<T>, Inv:Inv.Mov, Inv:Inv.Estatus, FormaSituacion)
...
Inv.Agente=Inv.Directo
Inv.Directo=Inv.VerLote
Inv.VerLote=(Fin)
