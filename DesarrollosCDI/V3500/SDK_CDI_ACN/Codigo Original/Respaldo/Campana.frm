...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Campana:Campana.Usuario) y<BR>(Campana:Campana.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar, EstatusPendiente))  y<BR>PuedeAvanzarEstatus(<T>CMP<T>, Campana:Campana.Mov, Campana:Campana.Estatus, FormaSituacion)
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>CMP<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>CMP<T>, Campana:Campana.Mov, Campana:Campana.Estatus, FormaSituacion)
