...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>RH<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>RH<T>, RH:RH.Mov, RH:RH.Estatus, FormaSituacion)
