...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>GES<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>GES<T>, Gestion:Gestion.Mov, Gestion:Gestion.Estatus, FormaSituacion)
...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Gestion:Gestion.Usuario) y<BR>(Gestion:Gestion.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar, EstatusPendiente, EstatusAltaPrioridad, EstatusPrioridadBaja))  y<BR>PuedeAvanzarEstatus(<T>GES<T>, Gestion:Gestion.Mov, Gestion:Gestion.Estatus, FormaSituacion)
EjecucionCondicion=ConDatos(Gestion:Gestion.Mov)
...
CampoColorFondo=Blanco
ListaEnCaptura=(Lista)
CondicionVisible=MovTipoEn(<T>GES<T>, Gestion:Gestion.Mov, (GES.SRES, GES.REU, GES.STAR)) o ((MovTipo(<T>GES<T>, Gestion:Gestion.Mov)=GES.MOD) y MovTipoEn(Gestion:Gestion.OrigenTipo, Gestion:Gestion.Origen, (GES.SRES, GES.REU, GES.STAR)))
...
CondicionVisible=(Gestion:Gestion.Estatus noen (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar)) y (MovTipo(<T>GES<T>, Gestion:Gestion.Mov) en (GES.SRES, GES.REU, GES.STAR, GES.TAR))
