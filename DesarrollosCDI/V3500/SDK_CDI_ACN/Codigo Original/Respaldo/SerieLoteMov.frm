...
AntesExpresiones=Asigna(Info.SumaSerieLote, Suma(SerieLoteMov:SerieLoteMov.Cantidad))<BR>Asigna(Info.SumaAlternaSerieLote, Suma(SerieLoteMov:SerieLoteMov.CantidadAlterna))
