...
MovTipoNomAutoCalendarioEsp=(Fin)

[Lista.ListaOrden]
(Inicio)=MovTipo.Modulo<TAB>(Acendente)
MovTipo.Modulo<TAB>(Acendente)=MovTipo.Orden<TAB>(Acendente)
MovTipo.Orden<TAB>(Acendente)=(Fin)
...
MovTipo.SubClave=MovTipo.RequiereAutorizacion
...
MovTipo.ObligacionFiscalTipoImporte=MovTipo.ModuloCentral
