...
Expresion=Mapa.Borrar<BR>Mapa.Agregar(<T>Cliente|EnviarA<T>, Cte:Cte.Cliente+<T>|<T>+CteEnviarA:CteEnviarA.ID)<BR>PlugIn(<T>Mapa<T>, <T>Cliente|EnviarA<T>, <T>Posicionar<T>)
Activo=S
Visible=S
