...
[Ficha.MovTipoContAuto.EsContactoAplica]
Carpeta=Ficha
Clave=MovTipoContAuto.EsContactoAplica
Editar=S
LineaNueva=S
3D=S
Tamano=30
...
[Lista.ListaOrden]
(Inicio)=MovTipoContAuto.Orden<TAB>(Acendente)
MovTipoContAuto.Orden<TAB>(Acendente)=MovTipoContAuto.Nombre<TAB>(Acendente)
MovTipoContAuto.Nombre<TAB>(Acendente)=(Fin)
...
Cta.Descripcion=MovTipoContAuto.CentroCostos
MovTipoContAuto.CentroCostos=MovTipoContAuto.ObligacionFiscal
MovTipoContAuto.ObligacionFiscal=MovTipoContAuto.Concepto
MovTipoContAuto.Concepto=MovTipoContAuto.OmitirConcepto
...
MovTipoContAuto.IncluirDepartamento=MovTipoContAuto.EsContactoAplica
MovTipoContAuto.EsContactoAplica=(Fin)
