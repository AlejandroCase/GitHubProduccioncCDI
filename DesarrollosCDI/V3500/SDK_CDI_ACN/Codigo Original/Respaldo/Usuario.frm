...
Plantillas=S
PermiteCopiarDoc=S
PlantillasExcepciones=Usuario:Usuario.Estatus<BR>Usuario:Usuario.TieneMovimientos
...
ConCondicion=S
EjecucionConError=S
EjecucionCondicion=Si<BR>  ContrasenaCorrecta(Usuario:Usuario.Contrasena, Usuario:Usuario.ContrasenaConfirmacion)<BR>Entonces<BR>  Si<BR>    Longitud(Usuario:Usuario.Contrasena)<32<BR>  Entonces<BR>    Asigna(Usuario:Usuario.Contrasena, MD5(Usuario:Usuario.Contrasena))<BR>    Asigna(Usuario:Usuario.ContrasenaConfirmacion, MD5(Usuario:Usuario.ContrasenaConfirmacion))<BR>  Fin<BR>  Verdadero<BR>Sino<BR>  Falso<BR>Fin
...
[Detalle.Usuario.MenuAccesoTotal]
Carpeta=Detalle
Clave=Usuario.MenuAccesoTotal
Editar=S
3D=S
Tamano=20
ColorFondo=Blanco
...
[Acciones.AccesoMenuVista]
Nombre=AccesoMenuVista
Boton=47
NombreEnBoton=S
Menu=&Edición
UsaTeclaRapida=S
TeclaRapida=Ctrl+F7
NombreDesplegar=Acceso &Menú
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=UsuarioMenuOpcion
ConCondicion=S
Antes=S
Visible=S
ActivoCondicion=(Usuario:Usuario.Menu<><T>(Clasico)<T>) y (no Usuario:Usuario.MenuAccesoTotal)
EjecucionCondicion=ConDatos(Usuario:Usuario.Menu)
AntesExpresiones=Asigna(Info.Usuario, Usuario:Usuario.Usuario)<BR>Asigna(Info.Menu, Usuario:Usuario.Menu)
...
Empresas=AccesoMenuVista
AccesoMenuVista=Impresoras
Impresoras=Anexos
Anexos=Propiedades
...
Usuario.ContrasenaConfirmacion=Usuario.GrupoTrabajo
...
UsuarioDestino.GrupoTrabajo=Usuario.Menu
Usuario.Menu=Usuario.MenuAccesoTotal
Usuario.MenuAccesoTotal=(Fin)
