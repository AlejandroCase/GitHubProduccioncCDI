...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Soporte:Soporte.Usuario) y <BR>(Soporte:Soporte.Estatus en (EstatusSinAfectar, EstatusPendiente, EstatusAltaPrioridad, EstatusPrioridadBaja)) y<BR>PuedeAvanzarEstatus(<T>ST<T>, Soporte:Soporte.Mov, Soporte:Soporte.Estatus, FormaSituacion) y<BR>((Soporte:Soporte.Usuario=Soporte:Soporte.UsuarioResponsable) o (Soporte:Soporte.Estatus=EstatusSinAfectar))
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>ST<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>ST<T>, Soporte:Soporte.Mov, Soporte:Soporte.Estatus, FormaSituacion)
...
Visible=S
EspacioPrevio=S
Expresion=EnviarMensaje(Soporte:Soporte.Titulo, Soporte:Soporte.Problema, <T>-----<T>+e(<T>Problema<T>)+<T>-----<T>, Soporte:Soporte.Solucion, <T>-----<T>+e(<T>Solución<T>)+<T>-----<T>, Soporte:Soporte.Comentarios, <T>-----<T>+e(<T>Comentarios<T>)+<T>-----<T>)
