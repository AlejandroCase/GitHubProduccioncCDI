...
Menus=S
PosicionColumna1=55
Comentarios=Lista(Info.ContMoneda, Si(Explorar.Grupo<><T><T>,e(Explorar.GrupoSingular)+<T>: <T>+Explorar.Grupo,<T><T>), e(Explorar.CuentaSingular)+<T>: <T>+Si(Explorar.Cuenta=<T><T>,e(<T>(todos)<T>),Explorar.Cuenta), e(<T>Ejercicio<T>)+<T>: <T>+Explorar.Ejercicio)
VentanaExclusiva=
VentanaEscCerrar=
