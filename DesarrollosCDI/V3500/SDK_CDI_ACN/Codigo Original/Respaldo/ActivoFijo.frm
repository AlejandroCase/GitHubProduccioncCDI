...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, ActivoFijo:ActivoFijo.Usuario) y <BR>(ActivoFijo:ActivoFijo.Estatus en (EstatusSinAfectar, EstatusPendiente)) y <BR>PuedeAvanzarEstatus(<T>AF<T>, ActivoFijo:ActivoFijo.Mov, ActivoFijo:ActivoFijo.Estatus, FormaSituacion)
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>AF<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>AF<T>, ActivoFijo:ActivoFijo.Mov, ActivoFijo:ActivoFijo.Estatus, FormaSituacion)
