...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Oferta:Oferta.Usuario) y <BR>(Oferta:Oferta.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>OFER<T>, Oferta:Oferta.Mov, Oferta:Oferta.Estatus, FormaSituacion) y<BR>(Oferta:Oferta.Estatus=EstatusSinAfectar)
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>OFER<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>OFER<T>, Oferta:Oferta.Mov, Oferta:Oferta.Estatus, FormaSituacion)
...
UsaTeclaRapida=S
TeclaRapida=Ctrl+T
AntesExpresiones=Asigna(Info.PuedeEditar, Oferta:Oferta.Estatus noen (EstatusConcluido, EstatusCancelado))<BR>Asigna(Info.Nombre, Nulo)<BR>Asigna(Info.Mov, Oferta:Oferta.Mov)<BR>Asigna(Info.MovID, Oferta:Oferta.MovID)<BR>Asigna(Info.Cliente, Oferta:Oferta.Cliente)<BR>Asigna(Info.Proveedor, Oferta:Oferta.Proveedor)<BR>Asigna(Info.Agente, Oferta:Oferta.Agente)<BR>Asigna(Info.Personal, Oferta:Oferta.Personal)<BR>Asigna(Info.Proyecto, Oferta:Oferta.Proyecto)<BR>Asigna(Info.UEN, Oferta:Oferta.UEN)<BR>Asigna(Info.Modulo, <T>OFER<T>)<BR>Asigna(Info.ID, Oferta:Oferta.ID)<BR>Asigna(Info.Reporte, Nulo)
...
Antes=S
DespuesGuardar=S
ActivoCondicion=Oferta:Oferta.Estatus=EstatusSinAfectar
...
AntesExpresiones=Asigna(Info.ID, OfertaD:OfertaD.ID)<BR>Asigna(Info.Articulo, OfertaD:OfertaD.Articulo)<BR>Asigna(Info.PuedeEditar, Oferta:Oferta.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador))
...
Visible=S
NombreEnBoton=S
ActivoCondicion=(MovTipo(<T>OFER<T>, Oferta:Oferta.Mov) <> OFER.OG) y (Oferta:Oferta.Estatus=EstatusSinAfectar)
...
TipoAccion=Formas
ClaveAccion=OfertaH
ActivoCondicion=(MovTipo(<T>OFER<T>, Oferta:Oferta.Mov) <> OFER.OG) y Oferta:Oferta.TieneVolumen
Antes=S
...
Art.Descripcion1=OfertaD.CostoBase
