...
Expresion=Si<BR> (ModuloExtra01:ModuloExtra01.Estatus en (EstatusPendiente))<BR>Entonces<BR>  Asigna(Info.Modulo, <T>MEX01<T>)<BR>  Asigna(Info.Mov, ModuloExtra01:ModuloExtra01.Mov)<BR>  Asigna(Info.MovID, ModuloExtra01:ModuloExtra01.MovID)<BR>  Si(Forma(<T>GenerarMovFlujo<T>), Generar(<T>MEX01<T>, ModuloExtra01:ModuloExtra01.ID, ModuloExtra01:ModuloExtra01.Mov, ModuloExtra01:ModuloExtra01.MovID, <T>Todo<T>, Info.MovGenerar, <T>ModuloExtra01<T>))<BR>Sino<BR>  Si<BR>    ModuloExtra01:ModuloExtra01.Estatus=EstatusSinAfectar<BR>  Entonces<BR>    Afectar(<T>MEX01<T>, ModuloExtra01:ModuloExtra01.ID, ModuloExtra01:ModuloExtra01.Mov, ModuloExtra01:ModuloExtra01.MovID, <T>Todo<T>, <T><T>, <T>ModuloExtra01<T>)<BR>  Sino<BR>    Asigna(Afectar.Modulo, <T>MEX01<T>)<BR>    Asigna(Afectar.Mov, ModuloExtra01:ModuloExtra01.Mov)<BR>    Asigna(Afectar.MovID, ModuloExtra01:Soporte.MovID) <BR>    Asigna(Afectar.ID, ModuloExtra01:ModuloExtra01.ID)<BR>    Asigna(Info.TituloDialogo, ModuloExtra01:ModuloExtra01.Mov+<T> <T>+ModuloExtra01:ModuloExtra01.MovID)<BR>    Asigna(Info.Estado, ModuloExtra01:ModuloExtra01.Estado)<BR>    Dialogo(<T>AfectarModuloExtra01<T>)<BR>  Fin<BR>Fin
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, ModuloExtra01:ModuloExtra01.Usuario) y <BR>(ModuloExtra01:ModuloExtra01.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>MEX01<T>, ModuloExtra01:ModuloExtra01.Mov, ModuloExtra01:ModuloExtra01.Estatus, FormaSituacion) y<BR>(ModuloExtra01:ModuloExtra01.Estatus=EstatusSinAfectar)
