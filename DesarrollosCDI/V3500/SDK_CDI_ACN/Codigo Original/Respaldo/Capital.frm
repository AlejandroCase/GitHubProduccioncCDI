...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Capital:Capital.Usuario) y <BR>(Capital:Capital.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>CAP<T>, Capital:Capital.Mov, Capital:Capital.Estatus, FormaSituacion) y<BR>(Capital:Capital.Estatus=EstatusSinAfectar)
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>CAP<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>CAP<T>, Capital:Capital.Mov, Capital:Capital.Estatus, FormaSituacion)
