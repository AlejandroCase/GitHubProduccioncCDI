...
PosicionCol1=507
ExpresionesAlMostrar=MC.TablaGet(<T>mcCampo<T>)<BR>MC.TablaGet(<T>mcMayor<T>)<BR>MC.TablaGet(<T>mcMayorDimension<T>)
...
Antes=S
DespuesGuardar=S
AntesExpresiones=MC.TablaPost(<T>mcMayor<T>)<BR>MC.TablaPost(<T>mcMayorDimension<T>)
