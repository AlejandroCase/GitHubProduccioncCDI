...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, ISL:ISL.Usuario) y <BR>(ISL:ISL.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>ISL<T>, ISL:ISL.Mov, ISL:ISL.Estatus, FormaSituacion) y<BR>(ISL:ISL.Estatus=EstatusSinAfectar)
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>ISL<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>ISL<T>, ISL:ISL.Mov, ISL:ISL.Estatus, FormaSituacion)
