...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Recluta:Recluta.Usuario) y<BR>((Recluta:Recluta.Estatus en (EstatusSinAfectar, EstatusPorConfirmar)) o<BR>((Recluta:Recluta.Estatus=EstatusPendiente) y<BR>PuedeAvanzarEstatus(<T>RE<T>, Recluta:Recluta.Mov, Recluta:Recluta.Estatus, FormaSituacion)))
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>RE<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>RE<T>, Recluta:Recluta.Mov, Recluta:Recluta.Estatus, FormaSituacion)
...
UsaTeclaRapida=S
TeclaRapida=Ctrl+T
AntesExpresiones=Asigna(Info.PuedeEditar, Recluta:Recluta.Estatus noen (EstatusConcluido, EstatusCancelado))<BR>Asigna(Info.Nombre, Nulo)<BR>Asigna(Info.Mov, Recluta:Recluta.Mov)<BR>Asigna(Info.MovID, Recluta:Recluta.MovID)<BR>Asigna(Info.Cliente, Recluta:Recluta.Cliente)<BR>Asigna(Info.Proveedor, Recluta:Recluta.Proveedor)<BR>Asigna(Info.Agente, Recluta:Recluta.Agente)<BR>Asigna(Info.Personal, Recluta:Recluta.Personal)<BR>Asigna(Info.Proyecto, Recluta:Recluta.Proyecto)<BR>Asigna(Info.UEN, Recluta:Recluta.UEN)<BR>Asigna(Info.Modulo, <T>RE<T>)<BR>Asigna(Info.ID, Recluta:Recluta.ID)<BR>Asigna(Info.Reporte, Nulo)
...
[Acciones.SugerirAtributos]
Nombre=SugerirAtributos
Boton=20
Menu=&Edición
UsaTeclaRapida=S
TeclaRapida=Ctrl+F8
NombreDesplegar=&Sugerir Atributos
GuardarAntes=S
EnBarraHerramientas=S
EnMenu=S
EspacioPrevio=S
...
Expresion=EjecutarSQL( <T>spReclutaAtributoSugerir :nID<T>, Recluta:Recluta.ID)
ActivoCondicion=Recluta:Recluta.Estatus=EstatusSinAfectar
[Comentarios]
Estilo=Ficha
Pestana=S
...
(Inicio)=ReclutaAtributoTipo.Tipo
ReclutaAtributoTipo.Tipo=ReclutaAtributoTipo.Peso
ReclutaAtributoTipo.Peso=(Fin)
...
MostrarConteoRegistros=S
Zona=A1
Vista=ReclutaAtributoTipo
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Recluta
LlaveLocal=ReclutaAtributoTipo.ID
LlaveMaestra=Recluta.ID
HojaTitulos=S
HojaMostrarColumnas=S
HojaMostrarRenglones=S
...
[PesoTipo.ReclutaAtributoTipo.Tipo]
Carpeta=PesoTipo
Clave=ReclutaAtributoTipo.Tipo
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[PesoTipo.ReclutaAtributoTipo.Peso]
Carpeta=PesoTipo
Clave=ReclutaAtributoTipo.Peso
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
(Inicio)=ReclutaD.Atributo
ReclutaD.Atributo=ReclutaD.Nivel
ReclutaD.Nivel=ReclutaD.Valor
...
CamposExtras=SugerirAtributos
SugerirAtributos=PersonalExpress
