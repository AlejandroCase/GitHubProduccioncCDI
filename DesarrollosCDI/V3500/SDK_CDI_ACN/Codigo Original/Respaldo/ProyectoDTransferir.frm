...
Activo=S
Visible=S
Expresion=RegistrarSeleccion(<T>Lista<T>)<BR>EjecutarSQL(<T>spProyectoDAsignar :ID, :nEstacion, :tRecurso, :tAccion<T>, Info.ID, EstacionTrabajo, <T><T>, <T>DESASIGNAR<T>)<BR>Forma.ActualizarForma
