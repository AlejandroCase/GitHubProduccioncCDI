...
EjecucionCondicion=ConDatos(Personal:Personal.Personal)
AntesExpresiones=GuardarCambios<BR>Asigna(Info.Personal, Personal:Personal.Personal)
[Acciones.CompetenciaCalificacion]
Nombre=CompetenciaCalificacion
Boton=0
Menu=&Edición
NombreDesplegar=Competencias del Personal
EnMenu=S
TipoAccion=Formas
ClaveAccion=CompetenciaCalificacion
Activo=S
ConCondicion=S
EjecucionCondicion=ConDatos(Personal:Personal.Personal)
Antes=S
AntesExpresiones=GuardarCambios<BR>Asigna(Info.PersonalD, Personal:Personal.Personal)
Visible=S
...
Activo=S
Visible=S
Expresion=Mapa.Borrar<BR>RegistrarListaSt(<T>(Carpeta Abrir)<T>, <T>Personal.Personal<T>, Verdadero)<BR>Mapa.AgregarListaSt(<T>Cliente<T>)<BR>PlugIn(<T>Mapa<T>, <T>Personal<T>, <T>Posicionar<T>)
...
DatosLaborales=CompetenciaCalificacion
CompetenciaCalificacion=PersonalHerman
