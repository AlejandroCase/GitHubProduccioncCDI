...
ConCondicion=S
EjecucionConError=S
EjecucionCondicion=Redondea(Info.Importe, 2)=Redondea(Suma(CPCalMov:CPCalMov.Importe), 2)
EjecucionMensaje=<T>No Corresponde (Diferencia: <T>+ MonetarioEnTexto(Abs(Info.Importe-Suma(CPCalMov:CPCalMov.Importe)))+<T>)<T>
[Lista.Columnas]
Periodo=58
Importe=125
