...
Nombre=Listas Precios con Acceso
Icono=0
Modulos=(Todos)
ListaCarpetas=Lista
...
ListaEnCaptura=UsuarioPrecios.ListaPrecios
CarpetaVisible=S
Filtros=S
FiltroPredefinido=S
...
FiltroRespetar=S
FiltroTipo=General
FiltroGeneral=UsuarioPrecios.Usuario=<T>{Info.Usuario}<T>

[Lista.UsuarioPrecios.ListaPrecios]
Carpeta=Lista
