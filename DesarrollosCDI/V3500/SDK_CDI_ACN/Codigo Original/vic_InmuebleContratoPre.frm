...
Expresion=//EjecutarSQL(<T>vic_spCargaDetalleContrato :tInmueble, :tReferencia, :tFactor, :nImporte, :tEmpresa<T>, Info.Inmueble, Info.Descripcion, Info.vic_Factor, Info.Importe, Empresa)<BR>EjecutarSQL(<T>vic_spBorrarCargo :tInmueble, :tReferencia<T>,Info.Inmueble,Info.Descripcion)<BR>EjecutarSQL(<T>vic_spCargaDetalleContrato :tInmueble, :tReferencia, :tFactor, :nImporte, :tEmpresa<T>, Info.Inmueble, Info.Descripcion, Info.vic_Factores, Info.Importe, Empresa)
[Acciones.Detalle.Mostrar]
Nombre=Mostrar
Boton=0
TipoAccion=Formas
ClaveAccion=vic_InmuebleFactorContrato
Activo=S
Visible=S
...
(Inicio)=Info.Importe
Info.Importe=Info.vic_Factores
Info.vic_Factores=(Fin)

[(Variables).Info.vic_Factores]
Carpeta=(Variables)
Clave=Info.vic_Factores
Editar=S
ValidaNombre=S
3D=S
Tamano=15
