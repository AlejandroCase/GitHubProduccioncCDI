...
PosicionSec2=485
PosicionCol2=408
ExpresionesAlMostrar=Asigna(Info.MovID, Nulo)<BR>Asigna(Info.Importe, 0.0)<BR>Asigna(Info.EsNuevo, Falso)<BR>Asigna(Info.ID, 0)<BR>Asigna(Info.VicClaseContrato, <T>SOCIO<T>)
...
Detalle=S
VistaMaestra=Vic_ContratoClaseSoc
...
ExpAntesRefrescar=Vic_ContratoClaseSoc:Contrato.ClaseContrato = <T>PROVEEDOR<T>
[Generales]
Estilo=Ficha
Pestana=S
Clave=Generales
...
Expresion=CopiarMovimiento(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.ID, <T>vic_Contrato<T>)
[Acciones.Abrir]
Nombre=Abrir
Boton=2
Menu=&Archivo
...
EjecucionCondicion=Si(General.MovConcurrente y ConDatos(Vic_ContratoClaseSoc:Contrato.ID) y (Vic_ContratoClaseSoc:Contrato.UltimoCambio<>SQL(<T>spMovInfoVerUltimoCambio :nID, :tModulo<T>, Vic_ContratoClaseSoc:Contrato.ID, <T>PACTO<T>)), Dialogo(<T>MovConcurrente<T>) AbortarOperacion)<BR>Verdadero
...
GuardarAntes=S
DespuesGuardar=S
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.MovID, Vic_ContratoClaseSoc:Contrato.MovID)<BR>Asigna(Info.Fecha, Vic_ContratoClaseSoc:Contrato.FechaEmision)<BR>Asigna(Info.Estatus, Vic_ContratoClaseSoc:Contrato.Estatus)
...
Expresion=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.Clave, <T>PACTO<T>+Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Nombre, Vic_ContratoClaseSoc:Contrato.Mov+<T> <T>+Vic_ContratoClaseSoc:Contrato.MovID)<BR>Asigna(Info.Aplica, <T>Movimientos<T>)<BR>Forma(Si(Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusConcluido, EstatusCancelado), <T>EvaluacionCalificacionInfo<T>, <T>EvaluacionCalificacion<T>))
...
ActivoCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.ID)
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)
[Acciones.Imprimir]
Nombre=Imprimir
Boton=4
Menu=&Archivo
...
Expresion=ReporteImpresora(ReporteMovImpresora(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.Estatus), Vic_ContratoClaseSoc:Contrato.ID)
...
Expresion=ReportePantalla(ReporteMovPantalla(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.Estatus), Vic_ContratoClaseSoc:Contrato.ID)
...
Expresion=Asigna(Info.Forma, <T>Vic_ContratoClaseSoc<T>)<BR>Asigna(Info.Nombre, <T>Contratos<T>)<BR>Asigna(Info.Modulo, Nulo)<BR>Asigna(Info.Mov, Nulo)<BR>Si<BR>   Forma(<T>PlantillasOffice<T>)<BR>Entonces<BR>    PlantillaOffice( Info.PlantillaID )<BR>Fin
...
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)
[Acciones.Verificar]
Nombre=Verificar
Boton=41
Menu=&Archivo
...
GuardarAntes=S
RefrescarDespues=S
Expresion=Verificar(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.ID,Vic_ContratoClaseSoc:Contrato.Mov,Vic_ContratoClaseSoc:Contrato.MovID)
ActivoCondicion=Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.Mov)
...
ActivoCondicion=(ConfigModulo(<T>PACTO<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.Estatus, FormaSituacion)
AntesExpresiones=Si(Vacio(Vic_ContratoClaseSoc:Contrato.ID),GuardarCambios)
[Acciones.Sucursal]
Nombre=Sucursal
Boton=0
Menu=&Archivo
...
ActivoCondicion=Usuario.ModificarSucursalDestino y (Vic_ContratoClaseSoc:Contrato.Estatus=EstatusSinAfectar) y (no FormaBloqueada)
AntesExpresiones=Si(Vacio(Vic_ContratoClaseSoc:Contrato.ID),GuardarCambios)
...
Expresion=Asigna(Afectar.Modulo, <T>PACTO<T>)<BR>Asigna(Afectar.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Afectar.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Afectar.MovID, Vic_ContratoClaseSoc:Contrato.MovID)<BR>Asigna(Afectar.GenerarMov, Nulo)<BR>Asigna(Afectar.FormaCaptura, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.MovGenerar, Nulo)                      <BR>Asigna(Info.Estatus, SQL(<T>SELECT Estatus FROM Contrato WHERE ID=:nID<T>, Vic_ContratoClaseSoc:Contrato.ID))<BR><BR>Si<BR> Info.Estatus en (EstatusPendiente, EstatusVigente, EstatusVencido, EstatusConcluido)<BR>Entonces<BR>  /*                                       <BR>  Si<BR>    Precaucion(<T>¿ Esta Seguro que Desea Reestructurar el Movimiento <T>+Afectar.Mov+<T> <T>+Afectar.MovID+<T> ?<T>, BotonSi, BotonNo)=BotonSi<BR>  Entonces<BR>    Generar(<T>PACTO<T>, Afectar.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>, Afectar.Mov, Afectar.FormaCaptura)<BR>    Generar(Afectar.Modulo, Afectar.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>,<T>Contrato<T>,Afectar.FormaCaptura)<BR>  Fin<BR>  */<BR>  Dialogo(<T>GenerarContrato2<T>)<BR>Sino<BR>  /*<BR>  Si Info.Estatus en (EstatusVigente, EstatusConcluido) Entonces<BR>    Si Confirmacion(<T>Desea Renovar Contrato<T>, BotonSi, BotonNo) = BotonSi Entonces<BR>      //ProcesarSQL(<T>EXEC spMovCopiar :nSucursal, :tModulo, :nID, :tUsuario, :tFechaTrabajo, @Sub = 1, @GenerarMov = :tGenerarMov<T>,<BR>      //            Vic_ContratoClaseSoc:Contrato.Sucursal, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.ID, Usuario, FechaTrabajo, <T>Renovacion<T>)<BR>      Asigna(Afectar.GenerarMov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>      Generar(<T>PACTO<T>, Afectar.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>, Afectar.GenerarMov, Afectar.FormaCaptura)<BR><BR>    Fin<BR>  Fin<BR>  */<BR>  Si<BR>    Info.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)<BR>  Entonces<BR>    //ContratoRecalcular(Vic_ContratoClaseSoc:Contrato.ID)<BR>    Afectar(<T>PACTO<T>, Afectar.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>, Afectar.GenerarMov, Afectar.FormaCaptura)<BR>  Fin<BR>Fin
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Vic_ContratoClaseSoc:Contrato.Usuario) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador, EstatusPendiente, EstatusVigente, EstatusVencido, EstatusConcluido)) y<BR>PuedeAvanzarEstatus(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.Estatus, FormaSituacion)
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.Mov)
AntesExpresiones=Si<BR>  General.CamposExtras=<T>Campos Extras<T> y (Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)) y SQL(<T>SELECT CEAntesAfectar FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMov AND CE=1<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Entonces<BR>  Si(no CamposExtrasMovimiento(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.ID, Verdadero, Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)), AbortarOperacion)<BR>FIn
[Acciones.Eliminar]
Nombre=Eliminar
Boton=5
Menu=&Archivo
...
ActivoCondicion=(Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusVigente, EstatusCancelado)) y PuedeAfectar(Verdadero, Usuario.ModificarOtrosMovs, Vic_ContratoClaseSoc:Contrato.Usuario)
[Acciones.Cancelar]
Nombre=Cancelar
Boton=33
Menu=&Archivo
...
Expresion=Cancelar(<T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>, <T><T>, <T>PACTO<T>)
ActivoCondicion=PuedeAfectar(Usuario.Cancelar, Usuario.CancelarOtrosMovs, Vic_ContratoClaseSoc:Contrato.Usuario) y ConDatos(Vic_ContratoClaseSoc:Contrato.ID) y ConDatos(Vic_ContratoClaseSoc:Contrato.MovID) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSincro, EstatusPendiente, EstatusVigente))
AntesExpresiones=Asigna(Afectar.Mov, Vic_ContratoClaseSoc:Contrato.Mov )<BR>Asigna(Afectar.MovID, Vic_ContratoClaseSoc:Contrato.MovID )
...
GuardarAntes=S
RefrescarDespues=S
Expresion=ProcesarSQL(<T>spAfectar :tModulo, :nID, :tAccion<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.ID, <T>CONSECUTIVO<T>)
ActivoCondicion=Vacio(Vic_ContratoClaseSoc:Contrato.MovID)
VisibleCondicion=Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)
...
Expresion=Si<BR>  General.CamposExtras=<T>Campos Extras<T><BR>Entonces<BR>  CamposExtrasMovimiento(<T>Contratos<T>, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.ID, Falso, Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador))<BR>Sino<BR>  Asigna(Info.Aplica, <T>Contratos<T>)<BR>  Asigna(Info.Clave, Vic_ContratoClaseSoc:Contrato.ID)<BR>  Asigna(Info.Nombre, Vic_ContratoClaseSoc:Contrato.Mov+<T> <T>+ Vic_ContratoClaseSoc:Contrato.MovID)<BR>  Asigna(Info.Modulo, <T>PACTO<T>)<BR>  Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>  Asigna(Info.Categoria, vic_Contrato2:vic_Contrato.Categoria)<BR>  Asigna(Info.Grupo, vic_Contrato2:vic_Contrato.Grupo)<BR>  Asigna(Info.Familia, vic_Contrato2:vic_Contrato.Familia)<BR>  Asigna(Info.Departamento, Nulo)<BR>  Asigna(Info.Puesto, Nulo)                                                  <BR>  Asigna(Info.SIC, Nulo)<BR><BR>  Asigna(Temp.Reg, SQL(<T>spFormaExtraVisible :tAplica, :tModulo, :tMov, :tCat, :tGrupo, :tFam, :tDepto, :tPuesto, :tSIC<T>, Info.Aplica, Info.Modulo, Info.Mov, Info.Categoria, Info.Grupo, Info.Familia, Info.Departamento, Info.Puesto, Info.SIC))<BR>  Si(Temp.Reg[1]>1, Si(no Forma(<T>EspecificarFormaTipo<T>), AbortarOperacion), Asigna(Info.FormaTipo, Temp.Reg[2]))<BR>  Si<BR>    ConDatos(Info.FormaTipo)<BR>  Entonces<BR>    Si<BR>      Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador, EstatusVigente)<BR>    Entonces<BR>      iForma(Info.FormaTipo, Info.Aplica, Info.Clave, Info.Nombre)<BR>    Sino                <BR>      iConsulta(Info.FormaTipo, Info.Aplica, Info.Clave, Info.Nombre)<BR>    Fin<BR>  Sino<BR>    Informacion(<T>No Tiene Definida Ninguna Forma<T>)<BR>  Fin<BR>Fin
[Acciones.Tarea]
Nombre=Tarea
Boton=70
Menu=&Edición
...
GuardarAntes=S
ActivoCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.ID)
AntesExpresiones=Asigna(Info.Aplica, <T>Contratos<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)
[Acciones.Anexos]
Nombre=Anexos
Boton=77
...
AntesExpresiones=Asigna(Info.Rama, <T>PACTO<T>)<BR>Asigna(Info.Fecha, Vic_ContratoClaseSoc:Contrato.FechaEmision)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.AnexoCfg, (no FormaBloqueada) y (Usuario.ModificarAnexosMovConcluidos o (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado, EstatusConcluido))))<BR>Asigna(Info.Descripcion, Vic_ContratoClaseSoc:Contrato.Mov+<T> <T> +Vic_ContratoClaseSoc:Contrato.MovID)
...
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.ID) y ConDatos(vic_ContratoD:ContratoD.Actividad)
EjecucionMensaje=Si(Vacio(Vic_ContratoClaseSoc:Contrato.ID), <T>Es Necesario Guardar el Movimiento Antes de Ejecutar<T>)
AntesExpresiones=Asigna(Info.Rama, <T>PACTO<T>)<BR>Asigna(Info.Fecha, Vic_ContratoClaseSoc:Contrato.FechaEmision)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.AnexoCfg, (no FormaBloqueada) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado, EstatusConcluido)))<BR>Asigna(Info.Cuenta, ContratoD:ContratoD.Actividad)<BR>Asigna(Info.Descripcion, ContratoD:ContratoD.Asunto)
[Acciones.Contactos]
Nombre=Contactos
Boton=74
Menu=&Edición
...
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.MovID, Vic_ContratoClaseSoc:Contrato.MovID)
[Acciones.Fuente]
Nombre=Fuente
Boton=0
Menu=Forma&to
...
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.ID)
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.MovID, Vic_ContratoClaseSoc:Contrato.MovID)
[Acciones.Politica]
Nombre=Politica
Boton=0
...
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.Mov)
AntesExpresiones=Asigna(Info.Rama, <T>PACTO<T>)<BR>Asigna(Info.Clave, Vic_ContratoClaseSoc:Contrato.Mov)
...
EjecucionCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.Concepto)
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.Concepto, Vic_ContratoClaseSoc:Contrato.Concepto)
...
ActivoCondicion=ConDatos(Vic_ContratoClaseSoc:Contrato.MovID)
AntesExpresiones=Asigna(Info.Modulo, <T>PACTO<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Mov, Vic_ContratoClaseSoc:Contrato.Mov)<BR>Asigna(Info.MovID, Vic_ContratoClaseSoc:Contrato.MovID)
[Acciones.Navegador]
Nombre=Navegador
Boton=0
...
IconosAlineacion=de Arriba hacia Abajo
IconosConSenales=S
IconosSubTitulo=<T>Mov.Ctrl. Venta<T>
ElementosPorPagina=200
...
FiltroRespetar=S
FiltroTipo=General
IconosNombre=<T>Mov.Ctrl. Venta <T> + vic_Condicion:vic_Condicion.ID
FiltroGeneral=vic_Condicion.IDContrato IS NOT NULL
CondicionVisible=SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) noen (<T>VIC.O<T>)
...
EjecucionConError=S
Antes=S
ActivoCondicion=ConDatos(vic_Contrato2:vic_Contrato.ID) y (ConDatos(Vic_ContratoClaseSoc:Contrato.ID))<BR>y (SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMov<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) noen (<T>VIC.O<T>)))<BR><BR>//(Vic_ContratoClaseSoc:Contrato.Estatus en (EstatusSinAfectar))
...
Expresion=FormaPos(<T>vic_CondicionClaseSoc<T>, SQL(<T>vic_spCondicionAgregar :nID<T>, Vic_ContratoClaseSoc:Contrato.ID))<BR>EjecutarSQL(<T>vic_spCondicionEliminar :nID<T>, Vic_ContratoClaseSoc:Contrato.ID)
...
Boton=0
NombreDesplegar=&Actualizar Mov.Ctrl. Venta
EnMenu=S
TipoAccion=Expresion
Visible=S
...
Expresion=FormaPos(<T>vic_CondicionClaseSoc<T>, vic_Condicion:vic_Condicion.ID)
ActivoCondicion=(ConDatos(vic_Condicion:vic_Condicion.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
...
GuardarAntes=S
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y (ConDatos(vic_Contrato2:vic_Contrato.ID)) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
AntesExpresiones=Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Descripcion, Vic_ContratoClaseSoc:Contrato.Titulo)
[Minutas]
Estilo=Iconos
Pestana=S
PestanaOtroNombre=S
...
GuardarAntes=S
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y (ConDatos(vic_Contrato2:vic_Contrato.Inmueble)) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusSinAfectar, EstatusCancelado))
AntesExpresiones=Asigna(Info.Numero, Vic_ContratoClaseSoc:Contrato.ID)
...
GuardarAntes=S
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y (ConDatos(vic_Contrato2:vic_Contrato.Inmueble)) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
AntesExpresiones=Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)<BR>Asigna(Info.Inmueble, vic_Contrato2:vic_Contrato.Inmueble)
...
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y (ConDatos(vic_Contrato2:vic_Contrato.ID)) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
AntesExpresiones=Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)
...
ListaAccionesMultiples=(Lista)
GuardarAntes=S
ActivoCondicion=(Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusSinAfectar, EstatusCancelado, EstatusSinAfectar, EstatusBaja))
AntesExpresiones=Asigna(Info.Descripcion, <T>Contrato<T>)<BR>Asigna(Info.ID, Vic_ContratoClaseSoc:Contrato.ID)
...
[Generales.vic_Contrato.PInversion]
Carpeta=Generales
Clave=vic_Contrato.PInversion
Editar=S
ValidaNombre=S
3D=S
Tamano=15
...
Expresion=Si Precaucion(<T>¿ Esta seguro que desea eliminar este Mov.Ctrl. Venta ?<T>+ NuevaLinea + NuevaLinea + <T>Mov.Ctrl. Venta <T> + vic_Condicion:vic_Condicion.ID, BotonSi, BotonNo ) = BotonSi<BR>Entonces EjecutarSQL(<T>vic_spEliminaCondicion :nID<T>, vic_Condicion:vic_Condicion.ID)<BR>Sino<BR><T><T><BR>Fin
...
Boton=0
NombreDesplegar=&Eliminar Mov.Ctrl. Venta
Multiple=S
EnMenu=S
ListaAccionesMultiples=(Lista)
...
Expresion=FormaPos(<T>vic_ContratoGeneraTramites<T>, SQL(<T>vic_spContratoInsertaNuevoTramite :nIDContrato<T>, Vic_ContratoClaseSoc:Contrato.ID))
...
ActivoCondicion=(ConDatos(vic_CompraA:Compra.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
...
GuardarAntes=S
Expresion=FormaPos(<T>Compra<T>, SQL(<T>vic_spInsertaOrdenCompra :nIDContrato, :tMovContrato, :tMovIDContrato, :tEmpresa, :tUsuario, :fFechaEmision, :nSucursal, :tProveedor<T>,<BR>Vic_ContratoClaseSoc:Contrato.ID, Vic_ContratoClaseSoc:Contrato.Mov, Vic_ContratoClaseSoc:Contrato.MovID, Empresa, Usuario, FechaTrabajo, Sucursal, Vic_ContratoClaseSoc:Contrato.Proveedor))
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.Proveedor)) y<BR>(ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y<BR>(Vic_ContratoClaseSoc:Contrato.Estatus noen(EstatusCancelado, EstatusVigente)) o (vic_Contrato2:vic_Contrato.Gobierno) y<BR>(SQL(<T>SELECT 1 FROM Prov WHERE Proveedor=:tProveedor AND DefMoneda IS NOT NULL<T>, Vic_ContratoClaseSoc:Contrato.Proveedor)=1)
...
ActivoCondicion=(ConDatos(Vic_ContratoClaseSoc:Contrato.Proveedor)) y (ConDatos(Vic_ContratoClaseSoc:Contrato.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen(EstatusCancelado, EstatusVigente))
...
ActivoCondicion=(vic_Contrato2:vic_Contrato.Gobierno) y (SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) en (<T>VIC.O<T>))
VisibleCondicion=(vic_Contrato2:vic_Contrato.Gobierno) y (SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) en (<T>VIC.O<T>))
...
Estilo=Iconos
PestanaOtroNombre=S
PestanaNombre=Resumen Operaciones
Clave=LocalesDet
Detalle=S
MenuLocal=S
AlineacionAutomatica=S
...
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Vic_ContratoClaseSoc
LlaveLocal=vic_CondicionGlobal.IDContrato
LlaveMaestra=Contrato.ID
IconosCampo=(sin Icono)
IconosEstilo=Detalles
IconosAlineacion=de Arriba hacia Abajo
...
IconosSubTitulo=<T>Moneda<T>
ListaEnCaptura=(Lista)
IconosNombre=vic_CondicionGlobal.MonCot
CondicionVisible=SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) en (<T>VIC.INV<T>)
[Acciones.LOCExcel2]
Nombre=LOCExcel2
Boton=0
NombreDesplegar=&Enviar a excel
...
Boton=0
NombreDesplegar=&Inactiva Mov.Ctrl. Venta
EnMenu=S
TipoAccion=Expresion
Visible=S
...
Expresion=Si Precaucion(<T>¿Esta seguro que desea Inactivar este Mov.Ctrl. Venta?<T>+ NuevaLinea + NuevaLinea + <T>Mov.Ctrl. Venta <T> + vic_Condicion:vic_Condicion.ID, BotonSi, BotonNo ) = BotonSi<BR>Entonces EjecutarSQL(<T>vic_spCondicionInactivar :nID<T>, vic_Condicion:vic_Condicion.ID)<BR>Sino<BR><T><T>                                                         <BR>Fin
...
Cte.Nombre=Contrato.FechaEmision
...
NombreInmueble=vic_Contrato.PInversion
vic_Contrato.PInversion=vic_Contrato.DirFisica
...
CondicionVisible=SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) en (<T>VIC.INV<T>)
[CondInversion.vic_Contrato.Dafrecuencia]
Carpeta=CondInversion
...
[CondInversion.vic_Contrato.DAContFact]
Carpeta=CondInversion
...
[CondInversion.vic_Contrato.DAIVA]
Carpeta=CondInversion
Clave=vic_Contrato.DAIVA
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[CondInversion.vic_Contrato.DARISR]
Carpeta=CondInversion
Clave=vic_Contrato.DARISR
Editar=S
ValidaNombre=S
3D=S
Tamano=12
...
[CondInversion.vic_Contrato.DARIVA]
Carpeta=CondInversion
Clave=vic_Contrato.DARIVA
Editar=S
ValidaNombre=S
3D=S
Tamano=12
...
[CondInversion.vic_Contrato.DAMonCot]
Carpeta=CondInversion
Clave=vic_Contrato.DAMonCot
Editar=S
LineaNueva=S
...
[CondInversion.vic_Contrato.DAMonFact]
Carpeta=CondInversion
Clave=vic_Contrato.DAMonFact
Editar=S
ValidaNombre=S
...
[CondInversion.vic_Contrato.PorcentajeSociedad]
Carpeta=CondInversion
Clave=vic_Contrato.PorcentajeSociedad
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
EspacioPrevio=S
[CondInversion.vic_Contrato.FondoGarantia]
Carpeta=CondInversion
Clave=vic_Contrato.FondoGarantia
Editar=S
ValidaNombre=S
3D=S
Tamano=18
...
LineaNueva=S
[CondInversion.vic_Contrato.MetrosTotales]
Carpeta=CondInversion
Clave=vic_Contrato.MetrosTotales
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[CondInversion.vic_Contrato.MetrosVendibles]
Carpeta=CondInversion
Clave=vic_Contrato.MetrosVendibles
Editar=S
ValidaNombre=S
3D=S
Tamano=18
...
[CondInversion.FondoGarantiaAmort]
Carpeta=CondInversion
Clave=FondoGarantiaAmort
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Tamano=18
[CondInversion.FondoGarantiaPend]
Carpeta=CondInversion
Clave=FondoGarantiaPend
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[CondInversion.MetrosPorVender]
Carpeta=CondInversion
Clave=MetrosPorVender
Editar=S
ValidaNombre=S
3D=S
Tamano=18
...
[CondInversion.ListaEnCaptura]
(Inicio)=vic_Contrato.Dafrecuencia
vic_Contrato.Dafrecuencia=vic_Contrato.DAContFact
vic_Contrato.DAContFact=vic_Contrato.DAIVA
vic_Contrato.DAIVA=vic_Contrato.DARISR
vic_Contrato.DARISR=vic_Contrato.DARIVA
vic_Contrato.DARIVA=vic_Contrato.DAMonCot
vic_Contrato.DAMonCot=vic_Contrato.DAMonFact
vic_Contrato.DAMonFact=vic_Contrato.PorcentajeSociedad
vic_Contrato.PorcentajeSociedad=vic_Contrato.MetrosTotales
vic_Contrato.MetrosTotales=vic_Contrato.FondoGarantia
vic_Contrato.FondoGarantia=vic_Contrato.MetrosVendibles
vic_Contrato.MetrosVendibles=FondoGarantiaAmort
FondoGarantiaAmort=MetrosVendido
MetrosVendido=FondoGarantiaPend
FondoGarantiaPend=MetrosPorVender
MetrosPorVender=(Fin)
...
vic_Contrato.FechaInicio=vic_Contrato.FechaLFirma
vic_Contrato.FechaLFirma=vic_Contrato.FechaFirma
vic_Contrato.FechaFirma=vic_Contrato.FechaEntrega
vic_Contrato.FechaEntrega=vic_Contrato.FechaBaja
vic_Contrato.FechaBaja=vic_Contrato.FechaVencOb
vic_Contrato.FechaVencOb=(Fin)
...
[Tipo Relación.Columnas]
IDContrato=64
TipoRelacion=304
ClienteRelacion=80
ClienteNombreRelacion=604
...
Activo=S
Visible=S
Expresion=FormaPos(<T>vic_ContratoRelaciones<T>, SQL(<T>vic_spInsertarRelacionContratoEnPantalla :nID<T>, Vic_ContratoClaseSoc:Contrato.ID))<BR>EjecutarSQL(<T>vic_spEliminarRelacionContratoNoCapturada :nID<T>, Vic_ContratoClaseSoc:Contrato.ID)

[Acciones.RelacionesAgregar.Actualizar Vista]
Nombre=Actualizar Vista
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Actualizar Vista
...
[Acciones.RelacionesActualiza.ActualizarVista]
...
Boton=0
NombreDesplegar=&Actualizar Relación
GuardarAntes=S
Multiple=S
EnMenu=S
ListaAccionesMultiples=(Lista)
...
[Acciones.RelcionesEliminar .Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
...
[Acciones.RelcionesEliminar .ActualizarVista]
Nombre=ActualizarVista
Boton=0
TipoAccion=controles Captura
ClaveAccion=actualizar vista
...
[Acciones.RelcionesEliminar ]
Nombre=RelcionesEliminar 
Boton=0
...
Activo=S
Visible=S
[Acciones.RelcionesEliminar .ListaAccionesMultiples]
(Inicio)=Expresion
...
[Acciones.EliminarRelacion.expresion]
Nombre=expresion
Boton=0
TipoAccion=expresion
Activo=S
...
Expresion=Si Precaucion(<T>¿ Esta seguro que desea eliminar esta Relación ?<T>+ NuevaLinea + NuevaLinea + <T>Relación <T> + Vic_ContratoRelaciones:vic_ContratoRelaciones.ID, BotonSi, BotonNo ) = BotonSi<BR>Entonces EjecutarSQL(<T>vic_spEliminaRelacionContrato :nID<T>, Vic_ContratoRelaciones:vic_ContratoRelaciones.ID)<BR>Sino<BR><T><T><BR>Fin
[Acciones.EliminarRelacion.ActualizaVista]
...
ActivoCondicion=(ConDatos(Vic_ContratoRelaciones:vic_ContratoRelaciones.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
Visible=S
...
[Acciones.EliminarRelacion.ListaAccionesMultiples]
(Inicio)=expresion
...
[Tipo Relación.ListaEnCaptura]
(Inicio)=vic_ContratoRelaciones.IDContrato
vic_ContratoRelaciones.IDContrato=vic_ContratoRelaciones.TipoRelacion
vic_ContratoRelaciones.TipoRelacion=ClienteRelacion
ClienteRelacion=ClienteNombreRelacion
ClienteNombreRelacion=(Fin)

[Tipo Relación.ListaAcciones]
(Inicio)=RelacionesAgregar
RelacionesAgregar=RelacionesActualiza
RelacionesActualiza=EliminarRelacion
EliminarRelacion=(Fin)
...
Boton=0
TipoAccion=Expresion
Expresion=FormaPos(<T>vic_CondicionGlobal<T>, vic_CondicionGlobal:vic_CondicionGlobal.ID)
Activo=S
Visible=S


[Acciones.ActualizarCondicion.ActualizarVista]
Nombre=ActualizarVista
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Actualizar Vista
...
[Acciones.ActualizarCondicionG]
Nombre=ActualizarCondicionG
Boton=0
NombreDesplegar=&Actualizar Control Venta
GuardarAntes=S
Multiple=S
EnMenu=S
ListaAccionesMultiples=(Lista)
...
ActivoCondicion=(ConDatos(vic_CondicionGlobal:vic_CondicionGlobal.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
[Acciones.EliminarCondicionG.Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
Activo=S
...
Expresion=Si Precaucion(<T>¿ Esta seguro que desea eliminar este Control Venta ?<T>+ NuevaLinea + NuevaLinea + <T>Control Venta <T> +vic_CondicionGlobal:vic_CondicionGlobal.ID, BotonSi, BotonNo ) = BotonSi<BR>Entonces EjecutarSQL(<T>vic_spEliminaCondicion :nID<T>,vic_CondicionGlobal:vic_CondicionGlobal.ID)<BR>Sino<BR><T><T><BR>Fin
[Acciones.EliminarCondicionG.Actualizar Vista]
Nombre=Actualizar Vista
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Actualizar Vista
...
[Acciones.EliminarCondicionG]
Nombre=EliminarCondicionG
Boton=0
NombreDesplegar=&Eliminar Control Venta
GuardarAntes=S
Multiple=S
EnMenu=S
ListaAccionesMultiples=(Lista)
...
ActivoCondicion=(ConDatos(vic_CondicionGlobal:vic_CondicionGlobal.ID)) y (Vic_ContratoClaseSoc:Contrato.Estatus noen (EstatusCancelado))
[Acciones.ActualizarCondicionG.Actualizar Vista]
Nombre=Actualizar Vista
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Actualizar Vista

[Acciones.ActualizarCondicionG.Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
...
IconosAlineacion=de Arriba hacia Abajo
IconosConSenales=S
IconosSubTitulo=<T>Control Venta<T>
ElementosPorPagina=200
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=(Lista)
...
IconosNombre=<T>Control Venta <T> + vic_CondicionGlobal:vic_CondicionGlobal.ID
FiltroGeneral=vic_CondicionGlobal.IDContrato IS NOT NULL
CondicionVisible=SQL(<T>SELECT SubClave FROM MovTipo WHERE Modulo=:tModulo AND Mov=:tMovimiento<T>, <T>PACTO<T>, Vic_ContratoClaseSoc:Contrato.Mov) en (<T>VIC.INV<T>)
...
[CondicionesGlobales.vic_Local.NombreCorto]
Carpeta=CondicionesGlobales
Clave=vic_Local.NombreCorto
Editar=S
LineaNueva=S
...
[Acciones.AgregarCondicionG.Guardar Cambios]
Nombre=Guardar Cambios
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Guardar Cambios
...
[Acciones.AgregarCondicionG]
Nombre=AgregarCondicionG
Boton=0
NombreDesplegar=&Agregar Control Venta
GuardarAntes=S
Multiple=S
EnMenu=S
ListaAccionesMultiples=(Lista)
...
[Acciones.AgregarCondicionG.Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
Activo=S
...
Expresion=FormaPos(<T>vic_CondicionGlobal<T>, SQL(<T>vic_spInsertaCondicionGlobalEnPantalla :nID<T>, Vic_ContratoClaseSoc:Contrato.ID))<BR>EjecutarSQL(<T>vic_spEliminarCondicionGlobalNoCapturada :nID<T>, Vic_ContratoClaseSoc:Contrato.ID)
[Acciones.AgregarCondicionG.Actualiza Vista]
...
[Acciones.AgregarCondicicondeG.Guardar Cambios]
Nombre=Guardar Cambios
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Guardar Cambios
...
[Acciones.AgregarCondicicondeG.Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
Activo=S
...
Expresion=FormaPos(<T>vic_CondicionClaseSoc<T>, SQL(<T>vic_spInsertaCondiciondeGlobalEnPantalla :nID, :nidCondicion<T>, Vic_ContratoClaseSoc:Contrato.ID, vic_CondicionGlobal:vic_CondicionGlobal.ID))<BR>EjecutarSQL(<T>vic_spCondicionEliminar :nID<T>, Vic_ContratoClaseSoc:Contrato.ID)
[Acciones.AgregarCondicicondeG.Actualizar Vista]
Nombre=Actualizar Vista
Boton=0
TipoAccion=Controles Captura
...
[Acciones.AgregarCondicicondeG]
Nombre=AgregarCondicicondeG
Boton=0
NombreDesplegar=&Agregar Mov.Ctrl.Venta
GuardarAntes=S
Multiple=S
EnMenu=S
EspacioPrevio=S
...
14=-2
[LocalesDet.vic_CondicionGlobal.ImporteVenta]
Carpeta=LocalesDet
...
Totalizador=1
[LocalesDet.TotalImportePorSociedad]
Carpeta=LocalesDet
Clave=TotalImportePorSociedad
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Totalizador=1
[LocalesDet.TotalAmortizacionFondoGarantia]
Carpeta=LocalesDet
Clave=TotalAmortizacionFondoGarantia
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Totalizador=1
[LocalesDet.vic_CondicionGlobal.MetrosVendidos]
Carpeta=LocalesDet
...
Totalizador=1
[Condiciones.vic_Condicion.IDCondicionGlobal]
Carpeta=Condiciones
Clave=vic_Condicion.IDCondicionGlobal
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Acciones.AgregarCondicionG.ListaAccionesMultiples]
(Inicio)=Guardar Cambios
Guardar Cambios=Expresion
Expresion=Actualiza Vista
Actualiza Vista=(Fin)

[Acciones.ActualizarCondicionG.ListaAccionesMultiples]
(Inicio)=Expresion
Expresion=Actualizar Vista
Actualizar Vista=(Fin)


[Acciones.AgregarCondicicondeG.ListaAccionesMultiples]
(Inicio)=Guardar Cambios
Guardar Cambios=Expresion
Expresion=Actualizar Vista
Actualizar Vista=(Fin)
...
vic_Condicion.BasadoenVentas=vic_Condicion.IDCondicionGlobal
vic_Condicion.IDCondicionGlobal=(Fin)
...
[LocalesDet.PendientePorGenerar]
Carpeta=LocalesDet
Clave=PendientePorGenerar
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Totalizador=1
[CondicionesGlobales.PendientePorGenerar]
Carpeta=CondicionesGlobales
Clave=PendientePorGenerar
Editar=S
LineaNueva=S
...
(Inicio)=TotalUnidad
TotalUnidad=vic_CondicionGlobal.ImporteVenta
vic_CondicionGlobal.ImporteVenta=TotalImportePorSociedad
TotalImportePorSociedad=TotalAmortizacionFondoGarantia
TotalAmortizacionFondoGarantia=TotalImporte
TotalImporte=vic_CondicionGlobal.MetrosVendidos
vic_CondicionGlobal.MetrosVendidos=PendientePorGenerar
PendientePorGenerar=(Fin)
...
[Acciones.EliminarCondicionG.ListaAccionesMultiples]
(Inicio)=Expresion
Expresion=Actualizar Vista
Actualizar Vista=(Fin)
...
vic_CondicionGlobal.Frecuencia=Art.Descripcion1
Art.Descripcion1=vic_CondicionGlobal.ImporteVenta
vic_CondicionGlobal.ImporteVenta=PendientePorGenerar
PendientePorGenerar=vic_CondicionGlobal.MetrosVendidos
vic_CondicionGlobal.MetrosVendidos=vic_CondicionGlobal.FechaIni
vic_CondicionGlobal.FechaIni=vic_CondicionGlobal.FechaFin
vic_CondicionGlobal.FechaFin=vic_CondicionGlobal.MonCot
vic_CondicionGlobal.MonCot=vic_CondicionGlobal.MonFact
vic_CondicionGlobal.MonFact=vic_CondicionGlobal.Agrupador
vic_CondicionGlobal.Agrupador=vic_CondicionGlobal.Concepto
vic_CondicionGlobal.Concepto=vic_CondicionGlobal.ConLocal
vic_CondicionGlobal.ConLocal=vic_Local.NombreCorto
vic_Local.NombreCorto=(Fin)

[CondicionesGlobales.ListaAcciones]
(Inicio)=AgregarCondicionG
AgregarCondicionG=ActualizarCondicionG
ActualizarCondicionG=EliminarCondicionG
EliminarCondicionG=AgregarCondicicondeG
AgregarCondicicondeG=(Fin)
...
Fiador=Fianza
Fianza=Fechas
Fechas=CondInversion
CondInversion=CondicionesGlobales
CondicionesGlobales=Condiciones
