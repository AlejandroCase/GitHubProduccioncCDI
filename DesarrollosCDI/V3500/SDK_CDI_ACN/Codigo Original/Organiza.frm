...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>ORG<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>ORG<T>, Organiza:Organiza.Mov, Organiza:Organiza.Estatus, FormaSituacion)
