...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>CAPT<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>CAPT<T>, Captura:Captura.Mov, Captura:Captura.Estatus, FormaSituacion)
