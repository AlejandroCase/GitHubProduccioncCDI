...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Cxp:Cxp.Usuario) y <BR>(Cxp:Cxp.Estatus=EstatusSinAfectar) y<BR>PuedeAvanzarEstatus(<T>CXP<T>, Cxp:Cxp.Mov, Cxp:Cxp.Estatus, FormaSituacion)
