...
Expresion=ProcesarSQL(<T>spACSugerirRepartoDividendos :tEmpresa, :nSucursal, :tUsuario, :fFecha, :nEjercicio<T>, Empresa, Sucursal, Usuario, FechaTrabajo, Info.Ejercicio)
