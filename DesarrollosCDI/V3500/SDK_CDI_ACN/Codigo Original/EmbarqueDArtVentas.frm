...
[Lista.ListaOrden]
(Inicio)=EmbarqueDArt.Renglon<TAB>(Acendente)
EmbarqueDArt.Renglon<TAB>(Acendente)=EmbarqueDArt.RenglonSub<TAB>(Acendente)
EmbarqueDArt.RenglonSub<TAB>(Acendente)=(Fin)
