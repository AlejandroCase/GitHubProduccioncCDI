...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Asiste:Asiste.Usuario) y <BR>(Asiste:Asiste.Estatus en (EstatusSinAfectar, EstatusBorrador)) y<BR>PuedeAvanzarEstatus(<T>ASIS<T>, Asiste:Asiste.Mov, Asiste:Asiste.Estatus, FormaSituacion)
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>ASIS<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>ASIS<T>, Asiste:Asiste.Mov, Asiste:Asiste.Estatus, FormaSituacion)
