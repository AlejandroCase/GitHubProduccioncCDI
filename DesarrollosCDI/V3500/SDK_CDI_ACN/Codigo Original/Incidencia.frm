...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Incidencia:Incidencia.Usuario) y <BR>(Incidencia:Incidencia.Estatus en (EstatusSinAfectar, EstatusPendiente)) y<BR>PuedeAvanzarEstatus(<T>INC<T>, Incidencia:Incidencia.Mov, Incidencia:Incidencia.Estatus, FormaSituacion) y<BR>(Incidencia:Incidencia.Estatus=EstatusSinAfectar)
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>INC<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>INC<T>, Incidencia:Incidencia.Mov, Incidencia:Incidencia.Estatus, FormaSituacion)
