...
Boton=0
NombreDesplegar=Auto Generar Solicitud/Orden Acomodo (&Recibo) en...
EnMenu=S
TipoAccion=Formas
...
ActivoCondicion=Alm:Alm.GenerarOrdenAcomodoRecibo o Alm:Alm.GenerarSolAcomodoRecibo
AntesExpresiones=Asigna(Info.Almacen, Alm:Alm.Almacen)
VisibleCondicion=Alm:Alm.WMS
...
Boton=0
NombreDesplegar=Auto Generar Solicitud/Orden Acomodo (Reabastecimiento) en...
EnMenu=S
TipoAccion=Formas
...
ActivoCondicion=Alm:Alm.GenerarOrdenAcomodoSurtido o Alm:Alm.GenerarSolAcomodoSurtido
AntesExpresiones=Asigna(Info.Almacen, Alm:Alm.Almacen)
VisibleCondicion=Alm:Alm.WMS
[Acciones.Historico]
Nombre=Historico
...
[WMS.Alm.GenerarSolAcomodoRecibo]
Carpeta=WMS
Clave=Alm.GenerarSolAcomodoRecibo
Editar=S
LineaNueva=S
3D=S
Tamano=40
...
[WMS.Alm.GenerarSolAcomodoSurtido]
Carpeta=WMS
Clave=Alm.GenerarSolAcomodoSurtido
Editar=S
LineaNueva=S
3D=S
Tamano=40
...
Alm.SugerirSurtidoTarima=(Fin)

[WMS.Alm.SugerirSurtidoTarima]
Carpeta=WMS
Clave=Alm.SugerirSurtidoTarima
Editar=S
LineaNueva=S
3D=S
Tamano=40
...
Boton=0
Menu=&Edición
NombreDesplegar=Auto &Sugerir Surtido por Tarima al Generar...
EnMenu=S
TipoAccion=Formas
...
ActivoCondicion=Alm:Alm.SugerirSurtidoTarima
AntesExpresiones=Asigna(Info.Almacen, Alm:Alm.Almacen)
VisibleCondicion=Alm:Alm.WMS
...
AlmOrdenAcomodoSurtidoMov=AlmSugerirSurtidoTarima
