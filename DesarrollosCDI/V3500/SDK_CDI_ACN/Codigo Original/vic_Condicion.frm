...
CondicionVisible=(vic_Condicion:vic_Condicion.ConIncremento) y (vic_Condicion:vic_Condicion.TipoCondicion en (<T>RECURRENTE<T>))
[Control]
Estilo=Ficha
Pestana=S
PestanaOtroNombre=S
...
Expresion=Asigna(Info.Forma, <T>vic_Condicion<T>)<BR>Asigna(Info.Nombre, <T>Condición<T>)<BR>Asigna(Info.Modulo, Nulo)<BR>Asigna(Info.Mov, Nulo)<BR>Si                                       <BR>  Forma(<T>PlantillasOffice<T>)<BR>Entonces<BR>   PlantillaOffice( Info.PlantillaID ) <BR>Fin
[Acciones.Evento]
Nombre=Evento
Boton=0
Menu=&Edición
...
CondicionVisible=(vic_Condicion:vic_Condicion.BasadoenVentas) y (vic_Condicion:vic_Condicion.TipoCondicion en (<T>RECURRENTE<T>))
...
[Condiciones.vic_Condicion.ConsideraM2]
Carpeta=Condiciones
Clave=vic_Condicion.ConsideraM2
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
