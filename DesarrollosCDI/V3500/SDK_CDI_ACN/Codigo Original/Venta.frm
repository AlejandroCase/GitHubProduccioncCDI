...
FichaColorFondo=Plata
FichaAlineacionDerecha=S
Totalizadores1=Importe<BR>Desc<BR>Sub<BR>Impto<BR>Total<BR>Renglon<BR>Sobre Precio<BR>Peso<BR>Volumen
Totalizadores2=Suma(VentaD:Importe)<BR>-Suma(VentaD:DescGlobal)<BR>Suma(VentaD:SubTotal)<BR>Suma(VentaD:Impuesto)<BR>Redondea(Suma(VentaD:ImporteTotal), Config.VentaCobroRedondeoDecimales)-Venta:Venta.AnticiposFacturados-Venta:Venta.Retencion<BR>Conteo(VentaD:VentaD.Articulo)<BR>Suma(VentaD:ImporteSobrePrecio)<BR>Suma(VentaD:PesoTotal)<BR>Suma(VentaD:VolumenTotal)
Totalizadores3=(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR> <BR> <BR>#,.##<BR>#,.##
Totalizadores=S
...
Expresion=si (Info.Submodulo=<T>VTAS.F<T>) <BR> ENTONCES Asigna(Info.Descripcion, SQL(<T>EXEC spAbrirAnexo :tModulo, :nID<T>, <T>VTAS<T>, Venta:Venta.ID))<BR>Si (Info.Descripcion <> NULO) Y (Archivo.Leer(Info.Descripcion) <> <T><T>)<BR>Entonces<BR>  VerImagen(<T><T>, Info.Descripcion)<BR>Sino<BR>  ReporteImpresora(ReporteMovImpresora(Info.SubModuloVenta, Venta:Venta.Mov, Venta:Venta.Estatus), Venta:Venta.ID)<BR>Fin <BR> SINO <BR> ReporteImpresora(ReporteMovImpresora(Info.SubModuloVenta, Venta:Venta.Mov, Venta:Venta.Estatus), Venta:Venta.ID)<BR>  FIN
...
Expresion=si(Info.Submodulo=<T>VTAS.F<T>) <BR> ENTONCES <BR> Asigna(Info.Descripcion, SQL(<T>EXEC spAbrirAnexo :tModulo, :nID<T>, <T>VTAS<T>, Venta:Venta.ID))<BR>Si (Info.Descripcion <> NULO) Y (Archivo.Leer(Info.Descripcion) <> <T><T>)<BR>Entonces<BR>  VerImagen(<T><T>, Info.Descripcion)<BR>Sino<BR>  ReportePantalla(ReporteMovPantalla(Info.SubModuloVenta, Venta:Venta.Mov, Venta:Venta.Estatus), Venta:Venta.ID)<BR>Fin <BR> SINO <BR> ReportePantalla(ReporteMovPantalla(Info.SubModuloVenta, Venta:Venta.Mov, Venta:Venta.Estatus), Venta:Venta.ID)<BR>  FIN
