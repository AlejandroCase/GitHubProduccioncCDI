...
Visible=S
Antes=S
AntesExpresiones=Asigna(Info.MovID, DineroPendiente:DineroPendiente.MovID)<BR>Asigna(Info.Importe, DineroPendiente:DineroPendiente.Saldo)<BR>Asigna(Info.Copiar, Verdadero)
