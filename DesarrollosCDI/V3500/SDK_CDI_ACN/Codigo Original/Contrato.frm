...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>PACTO<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>PACTO<T>, Contrato:Contrato.Mov, Contrato:Contrato.Estatus, FormaSituacion)
