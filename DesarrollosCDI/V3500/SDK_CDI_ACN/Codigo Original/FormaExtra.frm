...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, FormaExtra:FormaExtra.Usuario) y <BR>(FormaExtra:FormaExtra.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar))  y<BR>PuedeAvanzarEstatus(<T>FRM<T>, FormaExtra:FormaExtra.Mov, FormaExtra:FormaExtra.Estatus, FormaSituacion)
...
Visible=S
EspacioPrevio=S
ActivoCondicion=(ConfigModulo(<T>FRM<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>FRM<T>, FormaExtra:FormaExtra.Mov, FormaExtra:FormaExtra.Estatus, FormaSituacion)
