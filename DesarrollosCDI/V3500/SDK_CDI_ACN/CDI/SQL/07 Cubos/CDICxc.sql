...
EXEC spInsertarMedida 'CXC','Importe1','Importe1','Importe1','aggSum'
EXEC spInsertarMedida 'CXC','Importe2','Importe2','Importe2','aggSum'
EXEC spInsertarMedida 'CXC','Importe3','Importe3','Importe3','aggSum'
EXEC spInsertarMedida 'CXC','Importe4','Importe4','Importe4','aggSum'
EXEC spInsertarMedida 'CXC','Importe5','Importe5','Importe5','aggSum'
...
GO
EXEC spInsertarDimension 'CXC','FormaCobro','Normal','FormaCobro',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro','FormaCobro','FormaCobro','FormaCobro',1
GO
EXEC spInsertarDimension 'CXC','FormaCobro1','Normal','FormaCobro1',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro1','FormaCobro1','FormaCobro1','FormaCobro1',1
GO
EXEC spInsertarDimension 'CXC','FormaCobro2','Normal','FormaCobro2',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro2','FormaCobro2','FormaCobro2','FormaCobro2',1
GO
EXEC spInsertarDimension 'CXC','FormaCobro3','Normal','FormaCobro3',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro3','FormaCobro3','FormaCobro3','FormaCobro3',1
GO
EXEC spInsertarDimension 'CXC','FormaCobro4','Normal','FormaCobro4',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro4','FormaCobro4','FormaCobro4','FormaCobro4',1
GO
EXEC spInsertarDimension 'CXC','FormaCobro5','Normal','FormaCobro5',1
EXEC spInsertarDimensionNivel  'CXC','FormaCobro5','FormaCobro5','FormaCobro5','FormaCobro5',1
GO
--BEGM 20101214. Socio y membresia Req. 4662
EXEC spInsertarDimension 'CXC','Socio','Normal','Socio',1
EXEC spInsertarDimensionNivel  'CXC','Socio','Socio','Socio','Socio',1
GO

EXEC spInsertarDimension 'CXC','Membresia','Normal','Membresia',1
EXEC spInsertarDimensionNivel  'CXC','Membresia','Membresia','Membresia','Membresia',1
GO
...
Cxc.FormaCobro1,
Cxc.Importe1 * mt.Factor AS 'Importe1', 
Cxc.FormaCobro2,
Cxc.Importe2 * mt.Factor AS 'Importe2', 
Cxc.FormaCobro3, 
Cxc.Importe3 * mt.Factor AS 'Importe3', 
Cxc.FormaCobro4, 
Cxc.Importe4 * mt.Factor AS 'Importe4',
Cxc.FormaCobro5, 
Cxc.Importe5 * mt.Factor AS 'Importe5', 
'Socio' = cte.Socio, 
'Membresia' = cte.Membresia
FROM
Cxc
