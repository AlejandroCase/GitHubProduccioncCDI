...
/* Cubo_VTAS */  
--BEGM 20101214. Se agrego campo socio y membresia
EXEC spLimpiarCubo 'VTAS'
...
--BEGM 20101214. Dimensiones Socio y Membresia Req. 4662
EXEC spInsertarDimension 'VTAS','Socio','Normal','Socio',1
EXEC spInsertarDimensionNivel  'VTAS','Socio','Socio','Socio','Socio',1
GO

EXEC spInsertarDimension 'VTAS','Membresia','Normal','Membresia',1
EXEC spInsertarDimensionNivel  'VTAS','Membresia','Membresia','Membresia','Membresia',1
GO
...
SELECT
  ...
  'TipoVenta'		= c.Ruta, 
  'Socio'  = c.Socio, --BEGM 20101214. Nuevo Campo Req. 4662
  'Membresia'  = c.Membresia --BEGM 20101214. Nuevo Campo Req. 4662
