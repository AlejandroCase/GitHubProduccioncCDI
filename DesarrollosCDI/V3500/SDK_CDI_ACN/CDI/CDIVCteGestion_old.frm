...
FiltroGeneral=SituacionGestion=<T>Gestion<T> and isnull(Membresia,<T>99999999999<T>)<9999999999
...
Antes=S
Activo=S
AntesExpresiones=asigna(Info.CDIMembresia,CDIVCteGestion:CDIVCteGestion.Membresia)<BR>asigna(info.Agente,CDIVCteGestion:CDIVCteGestion.Gestor)<BR><BR>informacion(Info.Agente)
[Pendientes]
Estilo=Hoja
Pestana=S
PestanaOtroNombre=S
...
Totalizadores3=(Monetario)<BR>(Cantidades)<BR>dd/mmmm/aaaa<BR>(Cantidades)<BR>(Cantidades)
...
[CDIVMemGEstion.CDIVMemGest.estatus]
Carpeta=CDIVMemGEstion
Clave=CDIVMemGest.estatus
Editar=S
LineaNueva=S
...
CDIVMemGest.movid=CDIVMemGest.fechaemision
CDIVMemGest.fechaemision=CDIVMemGest.estatus
CDIVMemGest.estatus=CDIVMemGest.membresiainicial
CDIVMemGest.membresiainicial=CDIVMemGest.Accion
CDIVMemGest.Accion=CDIVMemGest.Acuerdo
CDIVMemGest.Acuerdo=CDIVMemGest.FechaCompromiso
CDIVMemGest.FechaCompromiso=(Fin)
