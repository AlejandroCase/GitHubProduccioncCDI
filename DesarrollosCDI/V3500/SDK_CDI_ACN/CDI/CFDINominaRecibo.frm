...
Expresion=ProcesarSQL(<T>EXEC spCFDINominaGenerar :nEstacionTrabajo, 0, :tUsuario, @IDEsp = :nID, @PersonalEsp = :tPersonal, @BanderaVersion = 0<T>, EstacionTrabajo, Usuario, CFDINominaRecibo:CFDINominaRecibo.ID, CFDINominaRecibo:CFDINominaRecibo.Personal)
...
Expresion=ProcesarSQL(<T>EXEC spCFDINominaGenerar :nEstacionTrabajo, 1, :tUsuario, @IDEsp = :nID, @PersonalEsp = :tPersonal, @BanderaVersion = 0<T>, EstacionTrabajo, Usuario, CFDINominaRecibo:CFDINominaRecibo.ID, CFDINominaRecibo:CFDINominaRecibo.Personal)
[Acciones.Actualizar]
Nombre=Actualizar
Boton=82
...
Totalizadores1=Total Percepciones<BR>Total Deducciones<BR>Total Otros Pagos<BR>Total<BR>Total Registros
Totalizadores2=suma(CFDINominaRecibo:CFDINominaRecibo.TotalPercepciones)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalDeducciones)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalOtrosPagos)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalPercepciones)+suma(CFDINominaRecibo:CFDINominaRecibo.TotalOtrosPagos)<BR>conteo(cCFDINominaRecibo:CFDINominaRecibo.RID)
