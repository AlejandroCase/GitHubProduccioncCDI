...
AccionesDerecha=S
ListaAcciones=(Lista)
ExpresionesAlMostrar=Asigna(Info.EstacionTrabajo, EstacionTrabajo)<BR>EjecutarSql(<T>xpCDICalInscGrupo :nM, :nE, :nB, :tP, :tG<T>, Info.Membresia, EstacionTrabajo, 0, Info.Programa, Info.Programa)
[CDITempInscrip]
Estilo=Hoja
...
Totalizadores2=suma(CDITempInscrip:CDITempInscrip.Descuento1)<BR>suma(CDITempInscrip:CDITempInscrip.Descuento2)<BR>suma(CDITempInscrip:CDITempInscrip.Descuento3)<BR>suma(CDITempInscrip:CDITempInscrip.Descuento4)<BR>suma(CDITempInscrip:CDITempInscrip.Precio)<BR>suma(CDITempInscrip:CDITempInscrip.descuentoimporte)<BR>suma(CDITempInscrip:PrecioCurso)
...
Expresion=Asigna(Info.EstacionTrabajo,EstacionTrabajo)<BR>ProcesarSql(<T>xpCDICalInscGrupo :nM, :nE, :nB, :tP, :tG<T>,info.Membresia,{EstacionTrabajo},1,Info.Programa,Info.Programa)
...
(Inicio)=CDITempInscrip.Cliente	(Acendente)
CDITempInscrip.Cliente	(Acendente)=CDITempInscrip.id	(Acendente)
CDITempInscrip.id	(Acendente)=CDITempInscrip.RenglonId	(Acendente)
CDITempInscrip.RenglonId	(Acendente)=(Fin)
