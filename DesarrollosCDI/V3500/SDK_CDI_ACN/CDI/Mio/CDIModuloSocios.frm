...
ExpresionesAlMostrar=Asigna( Info.CDINumero, 2 )<BR>Asigna(Info.Importe2,0)
MenuPrincipal=(Lista)
[(Carpeta Abrir)]
Estilo=Iconos
Clave=(Carpeta Abrir)
...
CondicionVisible=MovTipo( <T>SOC<T>, CDISocio:CDISocio.Mov ) en (SOC.ACEPTA, SOC.TEMPORAL)
...
Expresion=ReportePantalla(ReporteMovPantalla(<T>SOC<T>, CDISocio:CDISocio.Mov, CDISocio:CDISocio.Estatus), CDISocio:CDISocio.ID)
...
NombreSocioBaja=CDISocio.BajaTotal
CDISocio.BajaTotal=CDISocio.Cliente
CDISocio.Cliente=CDISocio.Socio
CDISocio.Socio=CDISocio.Membresia
CDISocio.Membresia=CDISocio.NIPCDI
CDISocio.NIPCDI=NombreSocio
NombreSocio=CDISocio.Edad
