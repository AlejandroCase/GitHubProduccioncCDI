...
TotAlCambiar=S
Totalizadores3=(Cantidades)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)<BR>(Monetario)
...
cdiIngrInsc.ClavePresupuestalPlan=cdiIngrInsc.mov
...
cdiIngrInsc.Nombre=cdiIngrInsc.MovRI
...
cdiIngrInsc.descuento4=cdiIngrInsc.MovApl
...
cdiIngrInsc.Impuestoaplica=cdiIngrInsc.Origen
