...
[Lista.CFDINominaRecibo.TotalOtrosPagos]
Carpeta=Lista
...
Totalizadores1=Total Percepcciones<BR>Total Deducciones<BR>Total Otros Pagos<BR>Total<BR>Total Registros
...
[(Carpeta Totalizadores).Total Percepcciones]
Carpeta=(Carpeta Totalizadores)
Clave=Total Percepcciones
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
Total Registros=Total Percepcciones
Total Percepcciones=Total Otros Pagos
...
Expresion=RegistrarListaSt(<T>Lista<T>,<T>CFDINominaRecibo:CFDINominaRecibo.RID<T>,<T>CFDINominaRecibo:CFDINominaRecibo.Personal<T>)
AntesExpresiones=RegistrarSeleccionModuloID(<T>Lista<T>, <T>CFDINominaRecibo.Personal<T>, <T>CFDINominaRecibo.RID<T>)  
...
CFDINominaRecibo.TotalDescuento=CFDINominaRecibo.TotalOtrosPagos
CFDINominaRecibo.TotalOtrosPagos=(Fin)
