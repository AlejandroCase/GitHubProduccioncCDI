...
[Otros.CEPlan.CDIPeriodoPreciosYdescuentos]
Carpeta=Otros
Clave=CEPlan.CDIPeriodoPreciosYdescuentos
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Otros.CEPlan.CDIGeneraCargoRecurrente]
Carpeta=Otros
Clave=CEPlan.CDIGeneraCargoRecurrente
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Otros.CEPlan.CDIMinimoEdadPermitido]
Carpeta=Otros
Clave=CEPlan.CDIMinimoEdadPermitido
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Tamano=20
[Otros.CEPlan.CDIMaximoEdadPermitido]
Carpeta=Otros
Clave=CEPlan.CDIMaximoEdadPermitido
Editar=S
ValidaNombre=S
3D=S
ColorFondo=Blanco
...
[Acciones.GenerarPlan]
Nombre=GenerarPlan
Boton=7
NombreEnBoton=S
NombreDesplegar=Generar Plan en Lote
EnBarraHerramientas=S
TipoAccion=Formas
ClaveAccion=CDICePlanGen
Activo=S
Visible=S
...
[Otros.CEPlan.CDIClavePresupuestalDev]
Carpeta=Otros
Clave=CEPlan.CDIClavePresupuestalDev
Editar=S
ValidaNombre=S
3D=S
Tamano=30
...
[Otros.CEPlan.PreciosPeriodo]
Carpeta=Otros
Clave=CEPlan.PreciosPeriodo
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Otros.CEPlan.CategoriaImagen]
Carpeta=Otros
Clave=CEPlan.CategoriaImagen
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Otros.CEPlan.SubCategoriaImagen]
Carpeta=Otros
Clave=CEPlan.SubCategoriaImagen
Editar=S
ValidaNombre=S
3D=S
Tamano=30
...
[Rutas.CEPlan.SubCategoriaImagen]
Carpeta=Rutas
Clave=CEPlan.SubCategoriaImagen
Editar=N
LineaNueva=S
...
[Rutas.CEPlan.InscripcionEn]
Carpeta=Rutas
Clave=CEPlan.InscripcionEn
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Boton=74
NombreEnBoton=S
NombreDesplegar=Comité
EnBarraHerramientas=S
EspacioPrevio=S
TipoAccion=Formas
ClaveAccion=CDIComiteImagen
Activo=S
Visible=S
...
CEPlan.CDIEdadMaxima=CEPlan.CDIMinimoEdadPermitido
CEPlan.CDIMinimoEdadPermitido=CEPlan.CDIMaximoEdadPermitido
CEPlan.CDIMaximoEdadPermitido=CEPlan.CDIEstaturaMinima
...
ClavePresupuestal.Descripcion=CEPlan.CDIPeriodo
CEPlan.CDIPeriodo=CEPlan.CDICobertura
CEPlan.CDICobertura=CEPlan.CDIPeriodoPreciosYdescuentos
CEPlan.CDIPeriodoPreciosYdescuentos=CEPlan.CDIGeneraCargoRecurrente
CEPlan.CDIGeneraCargoRecurrente=CEPlan.PreciosPeriodo
CEPlan.PreciosPeriodo=CEPlan.CDIClavePresupuestalDev
CEPlan.CDIClavePresupuestalDev=CEPlan.CategoriaImagen
CEPlan.CategoriaImagen=CEPlan.SubCategoriaImagen
CEPlan.SubCategoriaImagen=(Fin)


[Rutas.CEPlan.PrioridadWeb]
Carpeta=Rutas
Clave=CEPlan.PrioridadWeb
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Rutas.ListaEnCaptura]
(Inicio)=CEPlan.InscripcionEn
CEPlan.InscripcionEn=CEPlan.CategoriaImagen
CEPlan.CategoriaImagen=CEPlan.SubCategoriaImagen
CEPlan.SubCategoriaImagen=CEPlan.PrioridadWeb
CEPlan.PrioridadWeb=(Fin)
...
Boton=68
NombreEnBoton=S
NombreDesplegar=Planes Portal
EnBarraHerramientas=S
TipoAccion=Formas
ClaveAccion=CDIWTopPlanesGral
Activo=S
Visible=S
