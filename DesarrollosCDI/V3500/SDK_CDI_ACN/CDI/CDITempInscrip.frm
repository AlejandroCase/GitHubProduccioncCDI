...
AccionesDerecha=S
ListaAcciones=(Lista)
ExpresionesAlMostrar=Asigna(Info.EstacionTrabajo,EstacionTrabajo)<BR>EjecutarSql(<T>xpCDICalInsc1Param :nM, :nE, :nB, :tP<T>,info.CDIMembresia,{EstacionTrabajo},0, Info.Programa)
[CDITempInscrip]
Estilo=Hoja
Clave=CDITempInscrip
PermiteEditar=S
