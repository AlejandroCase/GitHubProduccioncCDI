...
FiltroGeneral=SituacionGestion=<T>Gestion<T> and isnull(Membresia,<T>99999999999<T>)<9999999999 and convert(int,DiasVencido)>0 and convert(int,DiasVencido)<=180
