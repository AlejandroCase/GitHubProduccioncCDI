...
EnMenu=S
TipoAccion=Formas
ClaveAccion=CDICasilleroGenRec
Activo=S
Visible=S
...
AntesExpresiones=asigna(info.numero,CDICasilleros:CDICasilleros.ID)<BR>asigna(Info.FaseID,CDICasilleros:CDICasilleros.PlanoID)<BR>asigna(info.tipo,CDICasilleros:CDICasilleros.Tipo)<BR>ASigna(info.cdicasal,CDICasilleros:CDICasilleros.Casillero)
[Acciones.Recibos.Variables Asignar]
Nombre=Variables Asignar
Boton=0
TipoAccion=Controles Captura
ClaveAccion=Variables Asignar
...
[Acciones.Recibos.Recibos]
Nombre=Recibos
Boton=0
TipoAccion=Formas
ClaveAccion=CDICasilleroRecibo
Activo=S
Visible=S
...
Activo=S
Antes=S
AntesExpresiones=asigna(info.cdicasal,CDICasilleros:CDICasilleros.Casillero)
Visible=S
[Acciones.Recibos.ListaAccionesMultiples]
(Inicio)=Variables Asignar
Variables Asignar=Recibos
Recibos=(Fin)
