...
ExpresionesAlMostrar=Ejecutar(<T>xpcdiCDIAutComs :fD, :fa, :nE<T>,Info.FechaD, Info.FechaA, EstacionTrabajo)
[CDICReq]
Estilo=Iconos
Pestana=S
PestanaOtroNombre=S
...
Carpeta=CDICReq
Clave=CDICReqEnc.situacionfecha
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Carpeta=CDICReq
Clave=CDICReqEnc.situacionusuario
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
NombreEnBoton=S
EspacioPrevio=S
AntesExpresiones=ASIGNA(Info.mov,CDICReqEnc:CDICReqEnc.mov)<BR>informacion(info.mov)
...
CDICReqEnc.FechaEmision=CDICReqEnc.Estatus
CDICReqEnc.Estatus=CDICReqEnc.CDIEstado
CDICReqEnc.CDIEstado=CDICReqEnc.situacion
CDICReqEnc.situacion=CDICReqEnc.situacionusuario
CDICReqEnc.situacionusuario=CDICReqEnc.situacionfecha
CDICReqEnc.situacionfecha=CDICReqEnc.usuario
