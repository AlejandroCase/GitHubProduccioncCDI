...
Expresion=ProcesarSQL(<T>EXEC spCFDINominaGenerar :nEstacionTrabajo, 0, :tUsuario, @IDEsp = :nID, @PersonalEsp = :tPersonal, @BanderaVersion = 1<T>, EstacionTrabajo, Usuario, CFDINominaRecibo:CFDINominaRecibo.ID, CFDINominaRecibo:CFDINominaRecibo.Personal)
...
Expresion=ProcesarSQL(<T>EXEC spCFDINominaGenerar :nEstacionTrabajo, 1, :tUsuario, @IDEsp = :nID, @PersonalEsp = :tPersonal, @BanderaVersion = 1<T>, EstacionTrabajo, Usuario, CFDINominaRecibo:CFDINominaRecibo.ID, CFDINominaRecibo:CFDINominaRecibo.Personal)
[Acciones.Actualizar]
Nombre=Actualizar
Boton=82
...
Totalizadores1=Total Percepciones<BR>Total Otros Pagos<BR>Total Deducciones<BR>Total<BR>Total Registros
Totalizadores2=suma(CFDINominaRecibo:CFDINominaRecibo.TotalPercepciones)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalOtrosPagos)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalDeducciones)<BR>suma(CFDINominaRecibo:CFDINominaRecibo.TotalPercepciones)+suma(CFDINominaRecibo:CFDINominaRecibo.TotalOtrosPagos)<BR>conteo(CFDINominaRecibo:CFDINominaRecibo.RID)
...
[(Carpeta Totalizadores).Total Percepciones]
Carpeta=(Carpeta Totalizadores)
Clave=Total Percepciones
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[(Carpeta Totalizadores).Total Otros Pagos]
Carpeta=(Carpeta Totalizadores)
Clave=Total Otros Pagos
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[(Carpeta Totalizadores).Total Deducciones]
Carpeta=(Carpeta Totalizadores)
Clave=Total Deducciones
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
Total Registros=Total Percepciones
Total Percepciones=Total Otros Pagos
Total Otros Pagos=Total
Total=Total Deducciones
Total Deducciones=(Fin)
