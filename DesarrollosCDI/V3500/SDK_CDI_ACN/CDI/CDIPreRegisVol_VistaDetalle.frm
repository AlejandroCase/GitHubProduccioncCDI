...
FiltroTipo=General
OtroOrden=S
ListaOrden=CDIPreRegisDet.id<TAB>(Decendente)
FiltroGeneral=CDIPreRegisDet.CDISocio=<T>{Info.CDISocio}<T><BR>or CDIPreRegisDet.Cliente=<T>{Info.CDISocio}<T><BR>and CDIPreRegisDet.FechaEmision >=<T>20140101<T>
