...
[Forma]
Clave=CDIExpAsistePersExt
Icono=0
Modulos=(Todos)
Nombre=Explorar Checadas Personal Externo
...
FiltroGrupo1=CDIExpAsistePers.Departamento
...
FiltroGrupo2=CDIExpAsistePers.Puesto
FiltroGeneral=CDIExpAsistePers.Tipo=<T>EXTERNO<T>
...
[Acciones.RepChecadas]
Nombre=RepChecadas
Boton=4
NombreDesplegar=Checadas Departamento
EnBarraHerramientas=S
...
NombreEnBoton=S
EspacioPrevio=S
ClaveAccion=CDIREPORTEChecadasDep
