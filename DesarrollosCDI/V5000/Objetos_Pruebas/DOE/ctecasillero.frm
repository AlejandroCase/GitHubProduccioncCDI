...
Expresion=ProcesarSql(<T>CDIsp_AsignaCasilleroClientes :nEstacion,      :tMov,     :nPlanoid,   :tUso,   :tcliente,         :tEmp,    :tTi,      :ncasillero, :nSuc,:tCon<T>,<BR>                                    estaciontrabajo, <T>Asignado<T>, info.faseid, usuario, info.cliente, empresa, info.tipo, info.numero,  sucursal, info.CDIcilindro)
