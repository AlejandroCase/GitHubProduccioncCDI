...
[Acciones.TopTenPitcheo]
Nombre=TopTenPitcheo
Boton=94
NombreEnBoton=S
NombreDesplegar=&Top Ten Pitcheo
Multiple=S
EnBarraHerramientas=S
EspacioPrevio=S
Activo=S
...
[Acciones.TopTenPitcheo.2]
Nombre=2
Boton=0
TipoAccion=expresion
Expresion=EjecutarSQL(<T>EXEC CDITopSlowPitcheo:tCLAVE<T>,  Info.CDITopTenTorneo)<BR>ActualizarForma
Activo=S
Visible=S



[Acciones.TopTenPitcheo.3]
Nombre=3
Boton=0
TipoAccion=formas
ClaveAccion=CDISlowPitcheo
Activo=S
Visible=S

[Acciones.TopTenPitcheo.ListaAccionesMultiples]
(Inicio)=1
1=2
2=3
3=(Fin)
...
Imprimir=TopTenPitcheo
TopTenPitcheo=Top10xEquipo
Top10xEquipo=(Fin)
