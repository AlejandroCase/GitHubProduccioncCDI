...
ExpresionesAlMostrar=Asigna(Info.Tipo,<T>Externo<T>)
...
ActivoCondicion=(Personal:Personal.Tipo=<T>Externo<T>) y (Personal:Personal.MovNomina=<T>Externos<T>)
EjecucionCondicion=Si<BR>  Personal:Personal.Confidencial<BR>Entonces<BR>  Asigna(Personal:Personal.ApellidoPaterno, Ofuscar(Personal:Personal.ApellidoPaterno))<BR>  Asigna(Personal:Personal.ApellidoMaterno, Ofuscar(Personal:Personal.ApellidoMaterno))<BR>  Asigna(Personal:Personal.Nombre, Ofuscar(Personal:Personal.Nombre))<BR>Fin
...
ActivoCondicion=ConDatos(Personal:Personal.Personal) y ConDatos(Personal:Personal.NIPCDI)
AntesExpresiones=Asigna(Info.Titulo,<T>Personal<T>)<BR>Asigna(Info.Personal,Personal:Personal.Personal)<BR>Asigna(Info.Referencia,Personal:Personal.NIPCDI)
...
Visible=S
Antes=S
AntesExpresiones=Asigna( Info.CDINIP, Personal:Personal.NIPCDI )<BR>Asigna( Info.Clave, Personal:Personal.Personal )<BR>Asigna( Info.Forma, <T>Personal<T> )
...
Estilo=Iconos
PestanaOtroNombre=S
PestanaNombre=Personal Externo
Clave=(Carpeta Abrir)
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
...
FiltroGeneral=Tipo=<T>Externo<T>
[Acciones.Actualizar]
Nombre=Actualizar
Boton=0
UsaTeclaRapida=S
...
EjecucionCondicion=ConDatos(Personal:Personal.Personal) y ConDatos(Personal:Personal.PeriodoTipo) y<BR>ConDatos(Personal:Personal.FormaPago) y ConDatos(Personal:Personal.CtaDinero) y<BR>ConDatos(Personal:Personal.SueldoDiario) y ConDatos(Personal:Personal.FechaAlta) y<BR>ConDatos(Personal:Personal.FechaAntiguedad) y ConDatos(Personal:Personal.Moneda)
EjecucionMensaje=<T>Campos Requeridos: Tipo Periodo, Forma Pago, Cuenta Pago, Sueldo Diario, Fecha Alta, Fecha Antiguedad, Moneda<T>
...
Boton=18
NombreEnBoton=S
NombreDesplegar=Cambio Jornada
GuardarAntes=S
EnBarraHerramientas=S
TipoAccion=Expresion
Activo=S
...
ConCondicion=S
Antes=S
Expresion=Si<BR>  Forma(<T>EspecificarFechas<T>)<BR>Entonces<BR>  EjecutarSQL(<T>exec Sp_CdiJornadaTem :tEmp, :tPEr, :tUsuario, :fDe, :fA<T>, Empresa,Info.Personal,Usuario, Info.FechaD, Info.FechaA) <BR> Forma(<T>CDIJornadaTemp<T>)<BR><BR>Fin
EjecucionCondicion=ConDatos(Personal:Personal.Personal)
AntesExpresiones=Asigna(Info.Personal, Personal:Personal.Personal)<BR>Asigna(Info.Nombre, Personal:NombreCompleto)
...
PersonalUltimoPago=EditarNIPCDI
EditarNIPCDI=Navegador
Navegador=Cerrar
Cerrar=Competencia
Competencia=Puesto
Puesto=Departamento
