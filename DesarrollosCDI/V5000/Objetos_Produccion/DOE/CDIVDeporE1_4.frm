...
Icono=0
Modulos=(Todos)
Nombre=Goleo Individual (Pag.Internet Goleo Individual)
...
FiltroGrupo2=CDIVDeporE1.Jugador
...
[Acciones.CDIVDeporE1_4]
Nombre=CDIVDeporE1_4
Boton=4
NombreEnBoton=S
NombreDesplegar=Goleo Individual
EnBarraHerramientas=S
TipoAccion=Reportes Pantalla
ClaveAccion=CDIVDeporE1_4
ListaParametros=S
Activo=S
Visible=S
...
CDIVDeporE1.Fecha=CDIVDeporE1.Goles
CDIVDeporE1.Goles=(Fin)

[Forma.ListaAcciones]
(Inicio)=Presentacion preliminar
Presentacion preliminar=CDIVDeporE1_4
CDIVDeporE1_4=(Fin)
