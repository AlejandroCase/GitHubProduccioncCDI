...
Totalizadores1=Carreras Anotadas
Totalizadores2=suma(CDIVSlowEB1:CDIVSlowEB1.C)
Totalizadores3=(Cantidades)
Totalizadores=S
TotCarpetaRenglones=CDIVSlowEB1
CampoColorLetras=Negro
CampoColorFondo=Plata
ListaEnCaptura=Carreras Anotadas
CarpetaVisible=S

[(Carpeta Totalizadores).Carreras Anotadas]
Carpeta=(Carpeta Totalizadores)
Clave=Carreras Anotadas
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
