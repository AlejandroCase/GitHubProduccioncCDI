...
ConCondicion=S
BarraBtnPagina=1
EjecucionCondicion=Asigna(Info.Cerrado,SQL(<T>SELECT dbo.fnPOSEstatusCajaBloqueada(:tCaja)<T>,Info.CtaCaja))<BR>EjecutarSQL(<T>EXEC spPOSUsuarioDesautoriza :tID<T>, Info.IDTexto)<BR>Asigna(Info.Usuario, Nulo)<BR>Asigna(Info.Contrasena, Nulo)<BR>Forma(<T>POSMovAutorizarSup<T>)<BR>Asigna(Ver.Todo,SQL(<T>SELECT dbo.fnPOSUsuarioPerfilAccion(:tID, :tAccion)<T>,Info.IDTexto, <T>EDITAR ENCABEZADO<T>))<BR>Si((no(Ver.Todo ) y Info.Cerrado)o(Info.Cerrado y Ver.Todo ),Error(<T>Caja Bloqueada<T>))<BR><BR><BR>Si<BR>  Ver.Todo =  Verdadero<BR>Entonces<BR><BR> SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1<BR>Sino<BR>  Si((no(Ver.Todo))y (no(Info.Cerrado)),Precaucion(<T>Requiere Autorización<T>))<BR>Fin
...
EjecucionCondicion=Forma( <T>POSMovAutorizarSup<T> )<BR>SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1
...
EjecucionCondicion=SQL(<T>SELECT dbo.fnPOSValidarCteMost(:tCliente)<T>, Info.Cliente) <> 1 y<BR>(Si<BR> SQL(<T>spPOSEstadoCaja :tID, :tUsuario<T>, Info.IDTexto, Usuario) = 1<BR>Entonces<BR>  EjecutarSQL(<T>EXEC spPOSUsuarioDesautoriza :tID<T>, Info.IDTexto)<BR>  Asigna(Info.Usuario, Nulo)<BR>  Asigna(Info.Contrasena, Nulo)<BR>  Forma(<T>POSMovAutorizarSup<T>)<BR>  SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1<BR>Sino<BR>Informacion(<T>LA CAJA ESTA CERRADA... VERIFIQUE......<T> )<BR>Fin)
...
ActivoCondicion=Pos.WebService
EjecucionCondicion=SQL(<T>SELECT dbo.fnPOSValidarCteMost(:tCliente)<T>, Info.Cliente) <> 1 y<BR>(Si<BR> SQL(<T>spPOSEstadoCaja :tID, :tUsuario<T>, Info.IDTexto, Usuario) = 1<BR>Entonces<BR>  EjecutarSQL(<T>EXEC spPOSUsuarioDesautoriza :tID<T>, Info.IDTexto)<BR>  Asigna(Info.Usuario, Nulo)<BR>  Asigna(Info.Contrasena, Nulo)<BR>  Forma(<T>POSMovAutorizarSup<T>)<BR>  SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1<BR>Sino<BR>Informacion(<T>LA CAJA ESTA CERRADA... VERIFIQUE......<T> )<BR>Fin)
EjecucionMensaje=<T>No se puede realizar un cobro crédito a Cliente Mostrador<T>
[Acciones.Separador6]
Nombre=Separador6
Boton=0
EsSeparador=S
...
EjecucionCondicion=Si<BR> SQL(<T>spPOSEstadoCaja :tID, :tUsuario<T>, Info.IDTexto, Usuario) = 0<BR>Entonces<BR>  EjecutarSQL(<T>EXEC spPOSUsuarioDesautoriza :tID<T>, Info.IDTexto)<BR>  Asigna(Info.Usuario, Nulo)<BR>  Asigna(Info.Contrasena, Nulo)<BR>  Forma(<T>POSMovAutorizarSup<T>)<BR>  SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1<BR>Sino<BR>Informacion(<T>LA CAJA YA ESTA ABIERTA... VERIFIQUE......<T> )<BR>Fin
...
EjecucionCondicion=Si<BR> SQL(<T>spPOSEstadoCaja :tID, :tUsuario<T>, Info.IDTexto, Usuario) = 1<BR>Entonces<BR>  EjecutarSQL(<T>EXEC spPOSUsuarioDesautoriza :tID<T>, Info.IDTexto)<BR>  Asigna(Info.Usuario, Nulo)<BR>  Asigna(Info.Contrasena, Nulo)<BR>  Forma(<T>POSMovAutorizarSup<T>)<BR>  SQL(<T>SELECT 1 FROM POSL WHERE ID =:tID AND UsuarioAutoriza IS NOT NULL<T>, Info.IDTexto)= 1<BR>Sino<BR>Informacion(<T>LA CAJA ESTA CERRADA... VERIFIQUE......<T> )<BR>Fin
