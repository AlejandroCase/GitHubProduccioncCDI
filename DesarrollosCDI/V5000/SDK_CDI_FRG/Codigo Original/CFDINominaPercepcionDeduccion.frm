...
FiltroGeneral=CFDINominaPercepcionDeduccion.ID = {Info.ID} AND<BR>CFDINominaPercepcionDeduccion.Personal = <T>{Info.Personal}<T> AND<BR>CFDINominaPercepcionDeduccion.Movimiento <> <T>Estadisticos<T>
