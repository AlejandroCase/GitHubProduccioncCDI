[Forma]
Clave=CDPersonalCamp
Nombre=Personal
Icono=4
Modulos=(Todos)
ListaCarpetas=(Lista)
CarpetaPrincipal=Detalle
PosicionInicialIzquierda=1523
PosicionInicialArriba=19
...
FiltroRespetar=S
FiltroTipo=General
FiltroGeneral=Personal.Personal=<T>00758<T>
...
Personal.Nombre=Personal.NIPCDI
Personal.NIPCDI=Personal.Direccion
