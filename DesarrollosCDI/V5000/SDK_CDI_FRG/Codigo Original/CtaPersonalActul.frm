[Forma]
Clave=CtaPersonalActul
Nombre=CtaPersonalActul
Icono=4
Modulos=(Todos)
ListaCarpetas=(Lista)
...
FiltroRespetar=S
FiltroTipo=General
FiltroGeneral=CtaPersonal.Personal = <T>{info.personal}<T> and<BR>CtaPersonal.Usuario = <T>{usuario}<T>
...
UsaTeclaRapida=S
TeclaRapida=F12
NombreDesplegar=Actualiza Datos
GuardarAntes=S
RefrescarDespues=S
Multiple=S
EnBarraHerramientas=S
...
Expresion=EjecutarSQL(<T>CDIActPersonal :tPersonal , :tUsu<T>, CtaPersonal:CtaPersonal.Personal,usuario)
