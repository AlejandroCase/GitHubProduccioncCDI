...
RefrescarDespues=S
EspacioPrevio=S
AntesExpresiones=EjecutarSql(<T>xpCDIPermisoFuturaMama :nI, :tE<T>,CDIPermisoFuturaMama:CDIPermisoFuturaMama.Id, empresa)<BR>asigna(info.id,CDIPermisoFuturaMama:CDIPermisoFuturaMama.Id)
[(Carpeta Abrir)]
Estilo=Iconos
Clave=(Carpeta Abrir)
AlineacionAutomatica=S
