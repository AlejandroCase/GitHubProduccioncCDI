...
ExpAlRefrescar=ActualizarForma   
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Socio Fallecimiento
Clave=Hereda
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
...
FichaColorFondo=Plata
FichaAlineacionDerecha=S
CondicionVisible=CDISocio:CDISocio.Mov en (<T>Cat Oro Heredada<T>) y condatos(CDISocio:CDISocio.Cliente)
[Hereda.Cte.Socio]
Carpeta=Hereda
Clave=Cte.Socio
Editar=N
...
[Hereda.ListaEnCaptura]
(Inicio)=Cte.Cliente
Cte.Cliente=Cte.Socio
Cte.Socio=Cte.Nombre
Cte.Nombre=Cte.Membresia
Cte.Membresia=CDISocio.Mov
CDISocio.Mov=Cte.Categoria
Cte.Categoria=(Fin)

[Hereda.Cte.Categoria]
Carpeta=Hereda
Clave=Cte.Categoria
Editar=S
LineaNueva=S
...
CDISocio.Subsidio=CDISocio.Recomendado
...
[Acciones.ActualizaRFC]
Nombre=ActualizaRFC
Boton=57
NombreDesplegar=&ActualizaRFC
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
...
CDISociosCargoRecD.Baja=CDISociosCargoRecD.RenglonTipo
CDISociosCargoRecD.RenglonTipo=(Fin)

[CDISociosCargoRecDBaja.CDISociosCargoRecD.RenglonTipo]
Carpeta=CDISociosCargoRecDBaja
Clave=CDISociosCargoRecD.RenglonTipo
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[CDISociosCargoRecD.CDISociosCargoRecD.RenglonTipo]
Carpeta=CDISociosCargoRecD
Clave=CDISociosCargoRecD.RenglonTipo
Editar=S
LineaNueva=S
...
CDISociosCargoRecD.Cantidad=CDISociosCargoRecD.FechaInicio
CDISociosCargoRecD.FechaInicio=CDISociosCargoRecD.FechaFin
CDISociosCargoRecD.FechaFin=CDISociosCargoRecD.RenglonTipo
CDISociosCargoRecD.RenglonTipo=(Fin)
...
[CDISocioCte.CDISocioCte.RutaImagen]
Carpeta=CDISocioCte
Clave=CDISocioCte.RutaImagen
Editar=S
ValidaNombre=S
3D=S
Pegado=S
...
[CDISocioCte.CDISocioCte.PersonalTelefonos]
Carpeta=CDISocioCte
Clave=CDISocioCte.PersonalTelefonos
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[CDISocioCte.CDISocioCte.PersonalTelefonoMovil]
Carpeta=CDISocioCte
Clave=CDISocioCte.PersonalTelefonoMovil
Editar=S
ValidaNombre=S
3D=S
Tamano=25
...
CDISocioCte.TelefonosLada=CDISocioCte.PersonalTelefonos
CDISocioCte.PersonalTelefonos=CDISocioCte.PersonalTelefonoMovil
CDISocioCte.PersonalTelefonoMovil=CDISocioCte.eMail1
...
CDISocioCte.CDIFacturarA=CDISocioCte.RutaImagen
CDISocioCte.RutaImagen=(Fin)
