...
Expresion=Si<BR>  Info.Desglosar en (<T>SI<T>, <T>si<T>, <T>Si<T>)<BR>Entonces<BR>  ReportePantalla( <T>CDIRepIngresosEgresos )<BR>SiNo<BR>  ReportePantalla( <T>CDIRepComparativoIngresosEgresosVar<T> )<BR>Fin
