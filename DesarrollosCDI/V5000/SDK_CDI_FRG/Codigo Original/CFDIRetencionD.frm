...
ConfirmarAntes=S
Expresion=Informacion(SQL(<T>EXEC spCFDIRetencionAfectar :nEstacion, :tEmpresa, :nSucursal, :tUsuario<T>, EstacionTrabajo, Empresa, Sucursal, Usuario))<BR>ActualizarVista<BR>ActualizarForma<BR>Forma.ActualizarArbol(<T>Lista<T>)
