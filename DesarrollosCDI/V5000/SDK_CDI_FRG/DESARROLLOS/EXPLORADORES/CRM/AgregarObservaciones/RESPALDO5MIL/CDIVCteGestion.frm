...
Antes=S
AntesExpresiones=asigna(Info.CDIMembresia,CDIVCteGestion:CDIVCteGestion.Membresia)
[Pendientes]
Estilo=Hoja
Pestana=S
PestanaOtroNombre=S
...
Totalizadores1=Saldo<BR>Promedio Dias Pago<BR>Ultima Gestión<BR>Tiempo Gestión
Totalizadores2=suma(CDIVGesPendCXC:CDIVGesPendCXC.saldo)<BR>sql(<T>xpCDIGestProm :nM<T>,CDIVCteGestion:CDIVCteGestion.Membresia)<BR>sql(<T>xpCDIGestFecha :nM<T>,CDIVCteGestion:CDIVCteGestion.Membresia)<BR>sql(<T>xpCDIDiasGest :nM<T>,CDIVCteGestion:CDIVCteGestion.Membresia)
Totalizadores=S
...
CDIVCteGestion.SituacionGestion=(Fin)
...
CDIVCteGestion.GestorNombre=(Fin)
